		...
		<body onload="document.myForm.nama_obat.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					&nbsp;&nbsp;
					<a href='rpo2.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success'><i class="bi bi-arrow-clockwise"></i></a>
					...
					&nbsp;&nbsp;
					<a href='rpo.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-info'><i class="bi bi-x-circle"></i> Input Data</a>
					&nbsp;&nbsp;
					<a href='rpo_opershift.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-info'><i class="bi bi-shadows"></i> Input Oper Shift</a>
					&nbsp;&nbsp;
			...
			<div class="row">
				...
				<table width="100%" border='1'>
					<tr>
						...
						<td align="center" style="border: 1px solid;" bgcolor='#708090'><font color='white'>EDIT<br>ATURAN PAKAI</font></td>	
						<td align="center" style="border: 1px solid;" bgcolor='#708090'><font color='white'>TAMBAH<br>PENJADWALAN</font></td>	
					...
					while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
						...
						<tr>
							...
							<td>
								<?php 
								echo $data[nama_obat]; 
								$qo="SELECT top(1)interval,id_rpo_header,id FROM ERM_RI_RPO where noreg='$noreg' and nama_obat='$data[nama_obat]'";
							...
							<td align="center"><a href='rpo_beri.php?id=<?php echo $id.'|'.$user.'|'.$id_rpo_header.'|'.$data[nama_obat]; ?>'>
								<font color='green'>[ + ]</font></a>
							</td>
							<td>									
								<?php 
								...
								<td width='2' align='center' bgcolor='#708090'><font color='white'>edit</font></td>
								<td width='2' align='center' bgcolor='#708090'><font color='white'>hapus</font></td>
								</tr>";
								...
								while   ($data2 = sqlsrv_fetch_array($hasil2,SQLSRV_FETCH_ASSOC)){
									...
									<td align='center'><img src='$ttd_keluarga' width='30px'></td>
									<td align='center'><a href='rpo_beri_edit.php?id=$id|$user|$data2[id_rpo_header]|$data2[id]'><font color='green'>[ ! ]</font></a></td>
									<td align='center'><a href='del_rpo_beri.php?id=$id|$user|$data2[id_rpo_header]|$data2[id]'><font color='red'>[ x ]</font></a></td>
									</tr>
									";
									$no2 += 1;
								}
				...
				<table width="100%" border="1">
					<tr>
						<td align='center'>no</td><td align='center'>tgl</td><td align='center'>jam</td><td align='center'>dioperkan oleh</td><td align='center'>diterima oleh</td>
					</tr>
					<?php 
					...
					noreg, petugas, userid, namapetugas, rpo
					from ERM_OPERSHIFT_RPO
					...
					while   ($data2 = sqlsrv_fetch_array($hasil2,SQLSRV_FETCH_ASSOC)){ 
						...
						<td align='center'>$data2[tgl]</td>
						<td align='center'>$data2[jam]</td>
						<td align='center'>$data2[userid]</td>
						<td align='center'>$data2[namapetugas]</td>
						</tr>
						";
