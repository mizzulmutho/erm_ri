...
<div class="container">
	...
	<body onload="document.myForm.diet.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-2">
						<label for="" class="col-sm-2">DIET</label>
					</div>					
					<div class="col-10">
						<input class="form-control" name="diet" value="<?php echo $diet;?>" id="" type="text" onfocus="nextfield ='simpan';" placeholder="">
					</div>										
				</div>
