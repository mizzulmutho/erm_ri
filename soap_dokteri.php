					...
					<td>
						<div class="row">
							...
							<div class="col-8 text-left">
								<b>Hasil Lab</b><br>
								<button type="submit" name="hasil_lab" class="btn btn-info btn-sm" onfocus="nextfield ='done';">Click untuk menampilkan Hasil Laborat</button>
								<button type="submit" name="hasil_lab_close" class="btn btn-warning btn-sm" onfocus="nextfield ='done';">Close Hasil Laborat</button>
								<?php 
                                ...
                                //jumlah
									...
									<tr>
									<td width='1%'><font size='2'>no</font></td>
									<td><font size='2'>tarif name</font></td>
									<td><font size='2'>kel pemeriksaan</font></td>
									<td><font size='2'>parameter name</font></td>
									<td><font size='2'>$hari</font></td>
									<td><font size='2'>$hari2</font></td>
									<td><font size='2'>$hari3</font></td>
									<td><font size='2'>$hari4</font></td>
									<td><font size='2'>$hari5</font></td>
									<td><font size='2'>$hari6</font></td>
									<td><font size='2'>$hari7</font></td>
									<td><font size='2'>$hari8</font></td>
									<td><font size='2'>$hari9</font></td>
									<td><font size='2'>$hari10</font></td>
									</tr>
									";
									$i=1;
									while   ($dhqlab = sqlsrv_fetch_array($hqlab, SQLSRV_FETCH_ASSOC)){     
										...
										<td><font size='2'>$dhqlab[$hari4]</font></td>
										<td><font size='2'>$dhqlab[$hari5]</font></td>
										<td><font size='2'>$dhqlab[$hari6]</font></td>
										<td><font size='2'>$dhqlab[$hari7]</font></td>
										<td><font size='2'>$dhqlab[$hari8]</font></td>
										<td><font size='2'>$dhqlab[$hari9]</font></td>
										<td><font size='2'>$dhqlab[$hari10]</font></td>
										</tr>
										";
						...
						<div class="row">
							<div class="col-12 text-center">
								<b>INPUT SOAP DPJP</b>
								<br>
								<a href='soap_dokter_all.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-danger' target='_blank'><i class="bi bi-info-circle"></i> Perbesar Form & Tampilkan Semua Fitur</a>
								&nbsp;&nbsp;
