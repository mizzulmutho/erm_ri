...
$q		= "select * from ERM_RI_ASSESMEN_AWAL where noreg='$noreg' and jenis like '%ASSESMEN_AWAL_GERIATRI%'";
...
if(empty($cekreg)){
	$q		= "select * from ERM_FORM where FORM='ASSESMEN_AWAL_GERIATRI'";
	$hasil  = sqlsrv_query($conn, $q);			  
	$data2	= sqlsrv_fetch_array($hasil, SQLSRV_FETCH_ASSOC);	
...
if (isset($_POST["simpan"])) {
	...
	echo "
	<script>
	top.location='form_assesmen_geriatri.php?id=$id|$user';
	</script>
	";
