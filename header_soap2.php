...
<div class="row">
     <div class="col-12">
          <table class="table table-bordered">
               <tr>
                    <td>Nama</td><td>: <?php echo $nama.' ('.$kelamin.')'.' - NORM :'.$norm;?></td>
               </tr>
               <tr>
                    <td>Tanggal Lahir</td><td>: <?php echo $tgllahir.' ('.$umur.')'.' - NIK :'.$nik ;?></td>
               </tr>
               <tr>
                    <td>Riwayat Alergi</td><td>: <?php echo $alergi.' - Diet : '.$diet;?></td>
               </tr>
          </table>
     </div>
</div>
