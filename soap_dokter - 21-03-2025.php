...
<div class="container-fluid">
	...
	<body onload="document.myForm.ku.focus();" style="background-color: #E8F9FF;">
		...
		<form method="POST" name='myForm' action="" enctype="multipart/form-data">
			<br>
			<a href='soap_dokter_all.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-danger' target='_blank'><i class="bi bi-info-circle"></i> Tampilkan Semua</a>
			&nbsp;&nbsp;
					...
					<div class="row">
						<div class="col-12 text-left">
							<font size="2">
								...
								FROM ERM_SOAP WHERE norm='$norm' and noreg = '$noreg' and kodedokter='$kodedokter'
								";
