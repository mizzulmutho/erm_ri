		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<font size='3px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					&nbsp;&nbsp;
					<a href='transfer_pasien_list.php?id=<?php echo $id.'|'.$user; ?>' class='btn btn-success'><i class="bi bi-box-arrow-in-right"></i> Transfer dari IGD</a>
					&nbsp;&nbsp;
				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<!-- <input class="" name="tr10" value="<?php echo $tr10;?>" id="" type="text" disabled size='90' placeholder=""> -->
								: <?php echo $tr10;?>
							</div>
						</div>
					</td>
				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<!-- <input class="" name="tr11" value="<?php echo $tr11;?>" id="" type="text" disabled size='90' placeholder=""> -->
								: <?php echo $tr11;?>
							</div>
						</div>
					</td>
				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<!-- <input class="" name="tr12" value="<?php echo $tr12;?>" id="" type="text" disabled size='90' placeholder=""> -->
								: <?php echo $tr12;?>
							</div>
						</div>
					</td>
								...
								<table width="100%" border='0'>
									...
									<tr>
										...
										<td>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											Suhu
											<!-- <input class="" name="tr20" value="<?php echo $tr20;?>" id="" type="text" disabled size='10' placeholder=""> 0C -->
											: <?php echo $tr20;?>
											<tr>
												<td>GCS</td>
												<td>
											...
											<tr>
												<td>Nadi</td>
												<td>
													<!-- <input class="" name="tr18" value="<?php echo $tr18;?>" id="" type="text" disabled size='10' placeholder="">  -->
													: <?php echo $tr18;?> x/mnt
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													Ritme :
													<?php echo $tr19;?> 
				...
				<table width="100%" border='1'>
					<tr>
						<td align="center">
							...
							<!-- <input class="" name="tr99" value="<?php echo $tr99;?>" id="" type="text" disabled size='50' onfocus="nextfield ='';" placeholder="Isikan Nama Pasien/Keluarga"> -->
							<?php 
							if($tr99){
						...
						<td align="center">
							...
							<!-- <input class="" name="tr100" value="<?php echo $tr100;?>" id="dokter" type="text" disabled size='50' onfocus="nextfield ='';" placeholder="Isikan Nama Dokter atau Kode Dokter"> -->
							<?php 
							if($tr100){
					...
					<tr>
						<td align="center">
							...
							<!-- <input class="" name="tr101" value="<?php echo $tr101;?>" id="karyawan1" type="text" disabled size='50' onfocus="nextfield ='';" placeholder="Isikan Nama Petugas"> -->
							<?php 
							if($tr101){
						...
						<td align="center">
							...
							?>
							<br>
							<input class="" name="tr102" value="<?php echo $tr102;?>" id="karyawan2" type="text" disabled size='50' onfocus="nextfield ='';" placeholder="Isikan Nama Petugas">
						</td>
					</tr>
				</table>
			</td>
