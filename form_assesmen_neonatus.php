			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						...
						<a href='form_assesmen_neonatus_print.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-info' target='_blank'><i class="bi bi-printer-fill"></i></a>	

						<i class="bi bi-window-plus"> &nbsp; <b>ASESMEN AWAL KEPERAWATAN NEONATUS</b></i>
				...
				<div class="col-12">
						...
						<tr>
							<td>
								<table>
									<tr>
										<td>MRS tanggal</td>
										<td><input type='date' name='tglrawat' value='<?php echo $tglrawat;?>'></td>
									</tr>
									<tr>
										<td>Nama Ibu</td>
										<td><input type='text' name='neo1' value='<?php echo $neo1;?>'></td>
									</tr>
									<tr>
										<td>Umur Ibu</td>
										<td><input type='text' name='neo2' value='<?php echo $neo2;?>'></td>
									</tr>
									<tr>
										<td>NoTelp Ibu</td>
										<td><input type='text' name='neo3' value='<?php echo $neo3;?>'></td>
									</tr>
									<tr>
										<td>Alamat</td>
										<td><input type='text' name='neo4' value='<?php echo $neo4;?>'></td>
									</tr>
									<tr>
										<td>Riwayat Pernikahan</td>
										<td><input type='text' name='neo5' value='<?php echo $neo5;?>'></td>
									</tr>
								</table>
							</td>
							<td>
								<table>
									<tr>
										<td>Nama Ayah</td>
										<td><input type='text' name='neo6' value='<?php echo $neo6;?>'></td>
									</tr>
									<tr>
										<td>Umur Ayah</td>
										<td><input type='text' name='neo7' value='<?php echo $neo7;?>'></td>
									</tr>
									<tr>
										<td>NoTelp Ayah</td>
										<td><input type='text' name='neo8' value='<?php echo $neo8;?>'></td>
									</tr>
								</table>								
							</td>
						</tr>	
					...
					<table border='0'>
						...
						<tr>
							...
							<td style="border: 1px solid;"><input type='text' name='neo9' value='<?php echo $neo9;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo10' value='<?php echo $neo10;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo11' value='<?php echo $neo11;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo12' value='<?php echo $neo12;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo13' value='<?php echo $neo13;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo14' value='<?php echo $neo14;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo15' value='<?php echo $neo15;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo16' value='<?php echo $neo16;?>'></td>
						</tr>
						<tr>
							<td style="border: 1px solid;">2</td>
							<td style="border: 1px solid;"><input type='text' name='neo17' value='<?php echo $neo17;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo18' value='<?php echo $neo18;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo19' value='<?php echo $neo19;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo20' value='<?php echo $neo20;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo21' value='<?php echo $neo21;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo22' value='<?php echo $neo22;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo23' value='<?php echo $neo23;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo24' value='<?php echo $neo24;?>'></td>
						</tr>
						<tr>
							<td style="border: 1px solid;">3</td>
							<td style="border: 1px solid;"><input type='text' name='neo25' value='<?php echo $neo25;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo26' value='<?php echo $neo26;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo27' value='<?php echo $neo27;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo28' value='<?php echo $neo28;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo29' value='<?php echo $neo29;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo30' value='<?php echo $neo30;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo31' value='<?php echo $neo31;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo32' value='<?php echo $neo32;?>'></td>
						</tr>
						<tr>
							<td style="border: 1px solid;">4</td>
							<td style="border: 1px solid;"><input type='text' name='neo33' value='<?php echo $neo33;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo34' value='<?php echo $neo34;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo35' value='<?php echo $neo35;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo36' value='<?php echo $neo36;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo37' value='<?php echo $neo37;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo38' value='<?php echo $neo38;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo39' value='<?php echo $neo39;?>'></td>
							<td style="border: 1px solid;"><input type='text' name='neo40' value='<?php echo $neo40;?>'></td>
						</tr>
					...
					<table border='0'>
						<tr>
							<td>
								...
								<input type='checkbox' name='neo54' value='Alergi' <?php if ($neo54=="Alergi"){echo "checked";}?> >
								Alergi &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <input type='text' name='neo55' value='<?php echo $neo55;?>'>

								<input type='checkbox' name='neo56' value='Gemeli' <?php if ($neo56=="Gemeli"){echo "checked";}?> >
								Gemeli  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <input type='text' name='neo57' value='<?php echo $neo57;?>'>

								<input type='checkbox' name='neo58' value='Merokok' <?php if ($neo58=="Merokok"){echo "checked";}?> >
								Merokok : <input type='text' name='neo59' value='<?php echo $neo59;?>'> <br> 

								<input type='checkbox' name='neo60' value='Penyakit Ayah' <?php if ($neo60=="Penyakit Ayah"){echo "checked";}?> >Penyakit Ayah : <input type='text' name='neo61' value='<?php echo $neo61;?>'>

								<input type='checkbox' name='neo62' value='Gol Darah Ibu' <?php if ($neo62=="Gol Darah Ibu"){echo "checked";}?> >Gol Darah Ibu : <input type='text' name='neo63' value='<?php echo $neo63;?>'>

								<input type='checkbox' name='neo64' value='Rhesus' <?php if ($neo64=="Rhesus"){echo "checked";}?> >Rhesus :
								<input type='text' name='neo65' value='<?php echo $neo65;?>'>

								<input type='checkbox' name='neo66' value='Gol Darah Ayah' <?php if ($neo66=="Gol Darah Ayah"){echo "checked";}?> >Gol Darah Ayah : <input type='text' name='neo67' value='<?php echo $neo67;?>'>
								<br>

								<input type='checkbox' name='neo68' value='Lainlain' <?php if ($neo68=="Lainlain"){echo "checked";}?> >Lainlain  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <input type='text' name='neo69' value='<?php echo $neo69;?>'>
					...
					<table border='0'>
						<tr>
							<td>
								<h6>D. Persalinan</h6>
								Umur Kehamilan   : 
								<input type='text' name='neo70' value='<?php echo $neo71;?>'> minggu    
								Kehamilan tunggal/kembar : <input type='text' name='neo72' value='<?php echo $neo72;?>'> <br>
								Lama Persalinan <br>
								kala 1 &nbsp;: <input type='text' name='neo73' value='<?php echo $neo73;?>'> jam <input type='text' name='neo74' value='<?php echo $neo74;?>'> menit  <br>     
								Kala II : <input type='text' name='neo75' value='<?php echo $neo75;?>'> jam <input type='text' name='neo76' value='<?php echo $neo76;?>'> menit <br>
								Ketuban pecah sebelum lahir <input type='text' name='neo77' value='<?php echo $neo77;?>'> jam &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='neo78' value='<?php echo $neo78;?>'> menit, <br>
								Air ketuban : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jumlah <input type='text' name='neo79' value='<?php echo $neo79;?>'> cc warna/bau &nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='neo80' value='<?php echo $neo80;?>'> <br>
								Letak bayi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type='text' name='neo81' value='<?php echo $neo81;?>'> jenis persalinan <input type='text' name='neo69' value='<?php echo $neo81;?>'> Indikasi Persalinan operatif <input type='text' name='neo82' value='<?php echo $neo82;?>'><br>
								Obat-obatan yang diberikan selama persalinan : <input type='text' name='neo83' value='<?php echo $neo83;?>' size='80'><br>
								Tanda-tanda gawat janin sebelum lahir &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type='text' name='neo84' value='<?php echo $neo84;?>' size='80'><br>
								Plasenta  : Berat <input type='text' name='neo85' value='<?php echo $neo85;?>'> gr   Ukuran : <input type='text' name='neo86' value='<?php echo $neo86;?>'> Kelainan : <input type='text' name='neo87' value='<?php echo $neo87;?>'><br>
							</td>
						</tr>
					</table>
					&nbsp;&nbsp;<input type='submit' name='simpan' value='simpan' style="color: white;background: #66CDAA;border-color: #66CDAA;">
						...
						<tr valign='top'>
							<td><h6>E. Keadaan  Bayi</h6>
								<table border='1'>
									<tr>
										<td>A (aktivity)</td>
										<td><input type='checkbox' name='neo88' value='YA' <?php if ($neo88=="YA"){echo "checked";}?> >Tidak ada respon</td>
										<td><input type='checkbox' name='neo89' value='YA' <?php if ($neo89=="YA"){echo "checked";}?> >Tangan dan kaki fleksi</td>
										<td><input type='checkbox' name='neo90' value='YA' <?php if ($neo90=="YA"){echo "checked";}?> >aktif</td>
									</tr>
									<tr>
										<td>P (Pulse/HR)</td>
										<td><input type='checkbox' name='neo91' value='YA' <?php if ($neo91=="YA"){echo "checked";}?> >< 60</td>
										<td><input type='checkbox' name='neo92' value='YA' <?php if ($neo92=="YA"){echo "checked";}?> >≥60 - < 100</td>
										<td><input type='checkbox' name='neo93' value='YA' <?php if ($neo93=="YA"){echo "checked";}?> >≥100</td>
									</tr>
									<tr>
										<td>G(Grimace/
											reflek)
										</td>
										<td><input type='checkbox' name='neo94' value='YA' <?php if ($neo94=="YA"){echo "checked";}?> >Tidak ada respon</td>
										<td><input type='checkbox' name='neo95' value='YA' <?php if ($neo95=="YA"){echo "checked";}?> >Sedikit respon bila dirangsang</td>
										<td><input type='checkbox' name='neo96' value='YA' <?php if ($neo96=="YA"){echo "checked";}?> >Batuk/bersin/ menangis Bila dirangsang</td>
									</tr>
									<tr>
										<td>A (Apearance atau warna kulit)</td>
										<td><input type='checkbox' name='neo97' value='YA' <?php if ($neo97=="YA"){echo "checked";}?> >Badan dan ekstremitas biru</td>
										<td><input type='checkbox' name='neo98' value='YA' <?php if ($neo98=="YA"){echo "checked";}?> >Ekstremitas biru, badan merah</td>
										<td><input type='checkbox' name='neo99' value='YA' <?php if ($neo99=="YA"){echo "checked";}?> >merah</td>
									</tr>
									<tr>
										<td>R(Respiratory/RR)</td>
										<td><input type='checkbox' name='neo100' value='YA' <?php if ($neo100=="YA"){echo "checked";}?> >Tidak ada respon</td>
										<td><input type='checkbox' name='neo101' value='YA' <?php if ($neo101=="YA"){echo "checked";}?> >Nafas pelan dan tidak teratur</td>
										<td><input type='checkbox' name='neo102' value='YA' <?php if ($neo102=="YA"){echo "checked";}?> >Tangis kuat</td>
									</tr>
									<tr>
										<td>1 menit</td>
										<td><input type='text' name='neo103' value='<?php echo $neo103;?>'></td>
										<td><input type='text' name='neo104' value='<?php echo $neo104;?>'></td>
										<td><input type='text' name='neo105' value='<?php echo $neo105;?>'></td>
									</tr>
									<tr>
										<td>5 menit</td>
										<td><input type='text' name='neo106' value='<?php echo $neo106;?>'></td>
										<td><input type='text' name='neo107' value='<?php echo $neo107;?>'></td>
										<td><input type='text' name='neo108' value='<?php echo $neo108;?>'></td>
									</tr>
								</table>
							</td>
							<td>
								<table>
									<tr><td>
										Berat badan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type='text' name='neo109' value='<?php echo $neo109;?>'> gram<br>
										Panjang badan &nbsp;: <input type='text' name='neo110' value='<?php echo $neo110;?>'> cm<br>
										Lingkar kepala : <input type='text' name='neo111' value='<?php echo $neo111;?>'> cm<br>
										Lingkar dada &nbsp;&nbsp;&nbsp;: <input type='text' name='neo112' value='<?php echo $neo112;?>'> cm<br>
										Lingkar lengan : <input type='text' name='neo113' value='<?php echo $neo113;?>'>cm<br>
									</td></tr>
									<tr>
										<td>
											Reflek bayi :<br>
											<input type='checkbox' name='neo114' value='YA' <?php if ($neo114=="YA"){echo "checked";}?> > Moro (terkejut)
											<input type='checkbox' name='neo115' value='YA' <?php if ($neo115=="YA"){echo "checked";}?> > Rootting (mencari)<br>
											<input type='checkbox' name='neo116' value='YA' <?php if ($neo116=="YA"){echo "checked";}?> > Sucking (hisap)
											<input type='checkbox' name='neo117' value='YA' <?php if ($neo117=="YA"){echo "checked";}?> > grapping (menggenggam)<br>
											<br>
											ASI Eksklusif : 
											<input type='checkbox' name='neo118' value='YA' <?php if ($neo118=="YA"){echo "checked";}?> > Ya           
											<input type='checkbox' name='neo119' value='YA' <?php if ($neo119=="YA"){echo "checked";}?> > Tidak<br>
											IMD             :  
											<input type='checkbox' name='neo120' value='YA' <?php if ($neo120=="YA"){echo "checked";}?> > Ya           
											<input type='checkbox' name='neo121' value='YA' <?php if ($neo121=="YA"){echo "checked";}?> > Tidak<br>
											Jam pertama : <input type='text' name='neo122' value='<?php echo $neo122;?>'><br>
											Jam kedua &nbsp;&nbsp;&nbsp;: <input type='text' name='neo123' value='<?php echo $neo123;?>'> <br>
											Rawat Gabung :     
											<input type='checkbox' name='neo124' value='YA' <?php if ($neo124=="YA"){echo "checked";}?> >  Ya         
											<input type='checkbox' name='neo125' value='YA' <?php if ($neo125=="YA"){echo "checked";}?> >  Tidak<br>
											HR &nbsp;&nbsp;&nbsp;: <input type='text' name='neo126' value='<?php echo $neo126;?>'>   
											RR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type='text' name='neo127' value='<?php echo $neo127;?>'>
											<br>
											Suhu : <input type='text' name='neo128' value='<?php echo $neo128;?>'> 0C      
											Resusitasi : <input type='text' name='neo129' value='<?php echo $neo129;?>'> <br>
								...
								<table>
									...
									<tr>
										...
										<td>
											...
											<input type='checkbox' name='neo136' value='YA' <?php if ($neo136=="YA"){echo "checked";}?> >Cepal hematoma    
						...
						<tr>
							<td>
								<table border="1" >
									...
									<tr>
										<td>Kepala</td><td><input type='text' name='neo214' value='<?php echo $neo214;?>' size='60'></td>
									</tr>
									<tr>
										<td>Dada</td><td><input type='text' name='neo215' value='<?php echo $neo215;?>' size='60'></td>
									</tr>
									<tr>
										<td>Abdomen</td><td><input type='text' name='neo216' value='<?php echo $neo216;?>' size='60'></td>
									</tr>
									<tr>
										<td>Extrimitas</td><td><input type='text' name='neo217' value='<?php echo $neo217;?>' size='60'></td>
									</tr>
									<tr>
										<td>Genetalia</td><td><input type='text' name='neo218' value='<?php echo $neo218;?>' size='60'></td>
									</tr>
						...
						<tr>
							<td>
								<table border="1">
									...
									<tr>
										<td>Pernafasan</td>
										<td><input type='checkbox' name='neo219' value='1' <?php if ($neo219=="1"){echo "checked";}?>><60x/mnt</td>
											<td><input type='checkbox' name='neo219' value='2' <?php if ($neo219=="2"){echo "checked";}?>>60-80x/mnt</td>
											<td><input type='checkbox' name='neo219' value='3' <?php if ($neo219=="3"){echo "checked";}?>>>80x/mnt</td>
											<?php 
											if($neo219=='1'){
												$tdow1_skor='0';
											}
										...
										<tr>
											<td>Sianosis</td>
											<td><input type='checkbox' name='neo220' value='1' <?php if ($neo220=="1"){echo "checked";}?>>Tidak ada sianosis</td>
											<td><input type='checkbox' name='neo220' value='1' <?php if ($neo220=="1"){echo "checked";}?>>Sianosis hilang dg O2</td>
											<td><input type='checkbox' name='neo220' value='1' <?php if ($neo220=="1"){echo "checked";}?>>Sianosis menetap walaupun diberikan O2</td>
											<?php 
											if($neo220=='1'){
												$tdow2_skor='0';
											}
										...
										<tr>
											<td>Retraksi</td>
											<td><input type='checkbox' name='neo221' value='1' <?php if ($neo221=="1"){echo "checked";}?>>Tidak ada Retraksi</td>
											<td><input type='checkbox' name='neo221' value='1' <?php if ($neo221=="1"){echo "checked";}?>>Retraksi Ringan</td>
											<td><input type='checkbox' name='neo221' value='1' <?php if ($neo221=="1"){echo "checked";}?>>Retraksi Berat</td>
											<?php 
											if($neo221=='1'){
												$tdow3_skor='0';
											}
										...
										<tr>
											<td>Merintih</td>
											<td><input type='checkbox' name='neo222' value='1' <?php if ($neo222=="1"){echo "checked";}?>>Tidak merintih</td>
											<td><input type='checkbox' name='neo222' value='1' <?php if ($neo222=="1"){echo "checked";}?>>Dpt di dengar dg stetoskop</td>
											<td><input type='checkbox' name='neo222' value='1' <?php if ($neo222=="1"){echo "checked";}?>>Dpt didengar tanpa alat bantu</td>
											<?php 
											if($neo222=='1'){
												$tdow4_skor='0';
											}
										...
										<tr>
											<td>Udara masuk</td>
											<td><input type='checkbox' name='neo223' value='1' <?php if ($neo223=="1"){echo "checked";}?>>Udara masuk</td>
											<td><input type='checkbox' name='neo223' value='1' <?php if ($neo223=="1"){echo "checked";}?>>Penurunan ringan udara masuk</td>
											<td><input type='checkbox' name='neo223' value='1' <?php if ($neo223=="1"){echo "checked";}?>>Tdk ada udara masuk</td>
											<?php 
											if($neo223=='1'){
												$tdow5_skor='0';
											}
															...
															<td><img src='Screenshot_6.jpg' width="50px">
																...
																<td><img src='Screenshot_7.jpg' width="50px">
																	...
																	<tr>
																		<td>rekoil lengan</td>
																		<td></td>
																		<td><img src='Screenshot_12.jpg' width="50px"><input type='checkbox' name='neo224' value='1' <?php if ($neo224=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_13.jpg' width="50px"><input type='checkbox' name='neo225' value='1' <?php if ($neo225=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_14.jpg' width="50px"><input type='checkbox' name='neo226' value='1' <?php if ($neo226=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_15.jpg' width="50px"><input type='checkbox' name='neo227' value='1' <?php if ($neo227=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_16.jpg' width="50px"><input type='checkbox' name='neo228' value='1' <?php if ($neo228=="1"){echo "checked";}?>></td>
																		<td></td>
																	</tr>
																	<?php 
																	if($neo224){
																	...
																	<tr>
																		...
																		<td><img src='Screenshot_17.jpg' width="50px"><input type='checkbox' name='neo229' value='1' <?php if ($neo229=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_18.jpg' width="50px"><input type='checkbox' name='neo230' value='1' <?php if ($neo230=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_19.jpg' width="50px"><input type='checkbox' name='neo231' value='1' <?php if ($neo231=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_20.jpg' width="50px"><input type='checkbox' name='neo232' value='1' <?php if ($neo232=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_21.jpg' width="50px"><input type='checkbox' name='neo233' value='1' <?php if ($neo233=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_22.jpg' width="50px"><input type='checkbox' name='neo234' value='1' <?php if ($neo234=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_23.jpg' width="50px"><input type='checkbox' name='neo235' value='1' <?php if ($neo235=="1"){echo "checked";}?>></td>
																	</tr>
																	<?php 
																	if($neo229){
																		$dow4=-1;
																	...
																	<tr>
																		...
																		<td><img src='Screenshot_24.jpg' width="50px"><input type='checkbox' name='neo236' value='1' <?php if ($neo236=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_25.jpg' width="50px"><input type='checkbox' name='neo237' value='1' <?php if ($neo237=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_26.jpg' width="50px"><input type='checkbox' name='neo238' value='1' <?php if ($neo238=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_27.jpg' width="50px"><input type='checkbox' name='neo239' value='1' <?php if ($neo239=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_28.jpg' width="50px"><input type='checkbox' name='neo240' value='1' <?php if ($neo240=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_29.jpg' width="50px"><input type='checkbox' name='neo241' value='1' <?php if ($neo241=="1"){echo "checked";}?>></td>
																		<td></td>
																	</tr>
																	<?php 
																	if($neo236){
																	...
																	<tr>
																		...
																		<td><img src='Screenshot_30.jpg' width="50px"><input type='checkbox' name='neo242' value='1' <?php if ($neo242=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_31.jpg' width="50px"><input type='checkbox' name='neo243' value='1' <?php if ($neo243=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_32.jpg' width="50px"><input type='checkbox' name='neo244' value='1' <?php if ($neo244=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_33.jpg' width="50px"><input type='checkbox' name='neo245' value='1' <?php if ($neo245=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_34.jpg' width="50px"><input type='checkbox' name='neo246' value='1' <?php if ($neo246=="1"){echo "checked";}?>></td>
																		<td><img src='Screenshot_35.jpg' width="50px"><input type='checkbox' name='neo247' value='1' <?php if ($neo247=="1"){echo "checked";}?>></td>
																		<td></td>
																	</tr>
													...
													<table border='0'>
														...
														<tr>
															<td>
																...
																<input type='text' name='neo294' value='<?php echo $neo294;?>'>
															</td>
															<td>
																Sidik telapak kaki kanan<br>
																<input type='text' name='neo295' value='<?php echo $neo295;?>'>
															</td>
															<td>
																Sidik ibu jari tangan kanan<br>
																<input type='text' name='neo296' value='<?php echo $neo296;?>'>
															</td>
														</tr>
														<tr>
															<td colspan="3">
																...
																<table border="0">
																	...
																	<tr>
																		<td>
																			...
																			<input type='text' name='neo297' value='<?php echo $neo297;?>'>
																		</td>
																		<td>
																			Ibu<br>
																			<input type='text' name='neo298' value='<?php echo $neo298;?>'>
																		</td>
																	</tr>
																</table>
															</td>
