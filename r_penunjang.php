                    ...
                    <td>
                        <div class="row">
                            <div class="col-6">
                                Laboratorium<br>
                                :
                                <textarea name= "lab" id="" style="min-width:500px; min-height:800px;" disabled><?php echo $lab;?></textarea>
                            </div>
                            <div class="col-6">
                                Radiologi<br>
                                :
                                <textarea name= "rad" id="" style="min-width:500px; min-height:800px;" disabled><?php echo $rad;?></textarea>
                            </div>
                        </div>
                    </td>
                </tr>
