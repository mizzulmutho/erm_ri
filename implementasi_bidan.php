...
<div class="container-fluid">
	...
	<body onload="document.myForm.pasien_mcu.focus();">
		<form method="POST" name='myForm' action="" enctype="multipart/form-data">
			<br>
			<a href='form_asuhankebidanan1.php?id=<?php echo $id.'|'.$user.'|'.$idrasuhan;?>' class='btn btn-warning'>Close</a>
			&nbsp;&nbsp;
			...
			<br>
			<div class="card">
				<b>Input Implementasi Kebidanan</b>
			</div>
				...
				<tr valign="top">
					...
					<td>
						...
						while 	($data = sqlsrv_fetch_array($hasil, SQLSRV_FETCH_ASSOC)){				  
							...
							// $ket = $data[ket];
							// $ket = preg_replace("/[^a-zA-Z0-9]/", "", $data[ket]);
							...
							if($rencana){
								echo "<input type='checkbox' name='master5$i' value='$ket' checked>$ket";
							}else{
								echo "<input type='checkbox' name='master5$i' value='$ket'>$ket";
							}
