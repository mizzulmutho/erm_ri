...
<!--             <div class="col-4">
    ...
    <br>
        ...
        <table class="table table-stripped table-hover datatab">
            ...
            <tbody>
                ...
                $filter3 = "and
                (ARM_PERIKSA.noreg NOT IN
                (SELECT        noreg
                FROM        ERM_RI_RESUME_APPROVEL))";
                ...
                if($sbu<>'RSPG'){
                    if(empty($noreg)){
                      ...
                      WHERE        $filter1 AND (ARM_PERIKSA.KODEUNIT = '$unit') and  (YEAR(ARM_PERIKSA.TGLENTRY) = '$tahun') $filter $filter2 $filter3
                      order by NOREG desc
                      ";
                  }else{
                      $q="
            ...
            if(empty($noreg)){
                ...
                //user perawat register tidak diklik.
                    ...
                    WHERE        $filter1 AND (ARM_PERIKSA.KODEUNIT in($kodeunit)) and  (YEAR(ARM_PERIKSA.TGLENTRY) = '$tahun') $filter $filter2 $filter3
    ...
    // <tr></tr>
            ...
            <br>
            <a href='px_krs.php?id=$user|$noreg|$sbu' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" style='color:red; text-decoration:none; font-weight:bold;'>
