...
//history cppt
$qhis="
SELECT        TOP (200) ERM_SOAP.kodedokter, ERM_SOAP.planning, ERM_SOAP.instruksi, Afarm_DOKTER.NAMA
FROM            ERM_SOAP INNER JOIN
Afarm_DOKTER ON ERM_SOAP.kodedokter = Afarm_DOKTER.KODEDOKTER
WHERE        (ERM_SOAP.noreg LIKE '%$noreg%') AND (ERM_SOAP.dpjp = '') order by id desc
";
				...
				<tr valign="top">
					<td width='10%'>History
						<table width="100%">
							...
							<tr>
								<td>Terapi Obat IGD
									<textarea class="form-control" name="" cols="100%" onfocus="nextfield ='';" style="min-height:200px;font-size: 8pt" disabled><?php echo $terapi_igd;?></textarea>
								</td>
							</tr>
							<tr>
						...
						<div class="row">
							<div class="col-6">
								<div class="col-12">Subjektif<br>
									<textarea name= "subjektif" id="" style="min-width:650px; min-height:80px;"><?php echo $subjektif;?></textarea>
								</div>
								<div class="col-6">Assesment<br>
									<textarea name= "assesment" id="" style="min-width:650px; min-height:80px;"><?php echo $assesment;?></textarea>
								</div>
							...
							<div class="col-6">
								<div class="col-12">
									<div class="row">
										<div class="col-12">
											Objektif<br>
											<textarea name= "objektif" id="" style="min-width:650px; min-height:80px;"><?php echo $objektif;?></textarea>
										</div>
									</div>
									<div class="col-12">
										<div class="row">
