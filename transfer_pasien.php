...
<!-- 				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<input class="" name="d_unit" value="" id="d_unit" type="text" size='40' placeholder="" required>
							</div>
						</div>
					</td>
				</tr>	
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<input class="" name="k_unit" value="" id="k_unit" type="text" size='40' placeholder="" required>
							</div>
						</div>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="row">
						...
						<div class="col-8">
							<br>
							<button type='submit' name='simpan' value='simpan' class="btn btn-info" type="button" style="height: 60px;width: 250px;"><i class="bi bi-save-fill"></i> buat form transfer baru</button>
						</div>
					</div>
				</td>
			</tr>	
		...
		<table class="table">
			<tr>
				...
				<td style="border: 1px solid;" bgcolor='#708090'><font color='white'>dari unit</font></td>
				<td style="border: 1px solid;" bgcolor='#708090'><font color='white'>ke unit</font></td>
				...
				<td align='center' style="border: 1px solid;" bgcolor='#708090'><font color='white'>px igd</font></td>
			</tr>
			<?php 
			$q="
			...
			while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
				...
				<td>$data[tr1]</td>
				<td>$data[tr2]</td>
				<td align='center'><a href='e_transfer.php?id=$id|$user|$data[id]'><font color='green'>[!]</font></a></td>
				<td align='center'><a href='del_transfer.php?id=$id|$user|$data[id]'><font color='red'>[x]</font></a></td>
				<td align='center'><a href='transfer_pasien_list.php?id=$id|$user|$data[id]'><font color='green'>&harr;</font></a></td>
				</tr>
				";						
				$no += 1;
