				...
				<div class="row">
					...
					if (empty($norm)){
						...
						if($role=='DOKTER'){
							...
							echo "<input class='form-control' name='kodedokter' value='$kodedokter' id='dokter' type='text' size='50' placeholder='Isikan Nama Petugas' required>";
						}else{
							echo "<input class='form-control' name='kodedokter' value='$kodedokter' id='dokter' type='text' size='50' placeholder='Isikan Nama Petugas' required>";
						}
						?>
