...
$namaPerawatPenerima = $dqrPerawatPenerima['PERAWATPENERIMA'];
		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<font size='3px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					<br>
					<a href='transfer_pasien.php?id=<?php echo $id.'|'.$user.'|'.$idtransfer;?>' class='btn btn-warning'><i class="bi bi-x-circle"></i> Close</a>
					&nbsp;&nbsp;
