				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								: <input type='radio' name='ed1' value='Indonesia' <?php if ($ed1=="Indonesia"){echo "checked";}?> >Indonesia
								<input type='radio' name='ed1' value='Inggris' <?php if ($ed1=="Inggris"){echo "checked";}?> >Inggris
								<input type='radio' name='ed1' value='Daerah' <?php if ($ed1=="Daerah"){echo "checked";}?> >Daerah
								<input type='radio' name='ed1' value='Lain-lain' <?php if ($ed1=="Lain-lain"){echo "checked";}?> >Lain-lain
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed2' value='Ya' <?php if ($ed2=="Ya"){echo "checked";}?> >Ya
								<input type='radio' name='ed2' value='Tidak' <?php if ($ed2=="Tidak"){echo "checked";}?> >Tidak
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed3' value='SD' <?php if ($ed3=="SD"){echo "checked";}?> >SD
								<input type='radio' name='ed3' value='SLTP' <?php if ($ed3=="SLTP"){echo "checked";}?> >SLTP
								<input type='radio' name='ed3' value='SLTA' <?php if ($ed3=="SLTA"){echo "checked";}?> >SLTA
								<input type='radio' name='ed3' value='S1' <?php if ($ed3=="S1"){echo "checked";}?> >S1
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed4' value='Baik' <?php if ($ed4=="Baik"){echo "checked";}?> >Baik
								<input type='radio' name='ed4' value='Kurang' <?php if ($ed4=="Kurang"){echo "checked";}?> >Kurang
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed5' value='Verbal' <?php if ($ed5=="Verbal"){echo "checked";}?> >Verbal
								<input type='radio' name='ed5' value='Tulisan' <?php if ($ed5=="Tulisan"){echo "checked";}?> >Tulisan
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed6' value='Tiak Ada' <?php if ($ed6=="Tiak Ada"){echo "checked";}?> >Tidak Ada
								<input type='radio' name='ed6' value='Ada' <?php if ($ed6=="Ada"){echo "checked";}?> >Ada
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed7' value='Ya' <?php if ($ed7=="Ya"){echo "checked";}?> >Ya
								<input type='radio' name='ed7' value='Tidak' <?php if ($ed7=="Tidak"){echo "checked";}?> >Tidak
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								: <input type='radio' name='ed8' value='Tulisan' <?php if ($ed8=="Tulisan"){echo "checked";}?> >Tulisan
								<input type='radio' name='ed8' value='Lisan' <?php if ($ed8=="Lisan"){echo "checked";}?> >Lisan
							</div>
						</div>
						<div class="row">
							<div class="col-4">
							...
							<div class="col-8">
								<input type='radio' name='ed9' value='Ya' <?php if ($ed9=="Ya"){echo "checked";}?> >Penggunaan Obat Secara Efektif dan Aman, Efek Samping Serta Interaksinya 
								<br>
								<input type='radio' name='ed10' value='Ya' <?php if ($ed10=="Ya"){echo "checked";}?> >Penggunaan peralatan medis secara efektif dan aman
								<br>
								<input type='radio' name='ed11' value='Ya' <?php if ($ed11=="Ya"){echo "checked";}?> >Potensi interaksi obat & makanan
								<br>
								<input type='radio' name='ed12' value='Ya' <?php if ($ed12=="Ya"){echo "checked";}?> >Hasil asesmen, diagnosis, dan rencana asuhan
								<br>
								<input type='radio' name='ed13' value='Ya' <?php if ($ed13=="Ya"){echo "checked";}?> >Diet dan Nutrisi
								<br>
								<input type='radio' name='ed14' value='Ya' <?php if ($ed14=="Ya"){echo "checked";}?> >Tehnik Rehabilitasi
								<br>
								<input type='radio' name='ed15' value='Ya' <?php if ($ed15=="Ya"){echo "checked";}?> >Orientasi ruangan 
								<br>
								<input type='radio' name='ed16' value='Ya' <?php if ($ed16=="Ya"){echo "checked";}?> >Pemeriksaan Penunjang
								<br>
								<input type='radio' name='ed17' value='Ya' <?php if ($ed17=="Ya"){echo "checked";}?> >Manajemen Nyeri
								<br>
								<input type='radio' name='ed18' value='Ya' <?php if ($ed18=="Ya"){echo "checked";}?> >Cuci tangan yang benar
								<br>
								<input type='radio' name='ed19' value='Ya' <?php if ($ed19=="Ya"){echo "checked";}?> >Pemasangan gelang 
								<br>
								<input type='radio' name='ed20' value='Ya' <?php if ($ed20=="Ya"){echo "checked";}?> >Edukasi Proses Rujukan 
								<br>
							</div>
						</div>
						<br>
