...
echo "</card>";
    ...
    if($jenis<>'Resume Medis'){
        ...
        <td align='center'>edit cppt</td>
        <td align='center'>resume igd</td>
  ...
  if($jenis<>'Resume Medis'){
    ...
    <td align='center'><a href='list_soap_edit.php?id=$id_header|$user' target='_blank' class='$class'><i class='bi bi-pencil-square'></i></a></td>
    <td align='center'><a href='http://192.168.10.245/ermri/resume_igd.php?id=$id_header|$user|$noreg' target='_blank' class='$class'><i class='bi bi-arrow-up-right-circle'></i></a></td>
