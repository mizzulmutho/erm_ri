...
<!-- 				<div class="row">
			...
			<table width="100%">
				<tr>
					...
					<td style="border: 1px solid;" bgcolor='#708090'><font color='white'>TGLTRANSFER</font></td>
					<td style="border: 1px solid;" bgcolor='#708090'><font color='white'>NOREG</font></td>
					<td style="border: 1px solid;" bgcolor='#708090'><font color='white'>NORM</font></td>
					<td align='center' style="border: 1px solid;" bgcolor='#708090'><font color='white'>pilih</font></td>
				</tr>
				<?php 
				$creg = substr($noreg, 1,12);

				$q="
				SELECT        TOP (100) ID, NOREG, NORM, 
				CONVERT(VARCHAR, TGLTRANSFER, 103) as TGLTRANSFER,
				...
				while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
					...
					<tr>
					<td>$no</td>
					<td>$data[TGLTRANSFER]</td>
					<td>$data[NOREG]</td>
					<td>$data[NORM]</td>
					<td align='center'><a href='transfer_pasien_igd.php?id=$id|$user|$idtransfer|$data[ID]'><font color='gren'><i class='bi bi-check-all'></i>
					</font></a></td>
					</tr>
					";
					$no += 1;
