		...
		<body onload="document.myForm.nama_obat.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					<br>
					<a href='rpo_detail.php?id=<?php echo $id.'|'.$user.'|'.$idrpo;?>' class='btn btn-warning'><i class="bi bi-x-circle"></i> Close</a>
					&nbsp;&nbsp;
...
<!-- 				<div class="row">
			...
			<table class='table'>
				...
				while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
					...
					$data[tgl]
					&nbsp;&nbsp;&nbsp;
					<a href='eresep_list_detail.php?id=$id|$user|$idrpo|$data[Id]'>
