	...
	<body onload="document.myForm.pasien_mcu.focus();">
		<font size='2px'>	
			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				&nbsp;&nbsp;
				<a href='form_asuhan_neonatus_baru.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success'><i class="bi bi-file-earmark-plus"></i></a>
				&nbsp;&nbsp;
				...
				<table class="table" border="1">
					...
					echo 
					"<tr bgcolor='#969392'>
					<td>no</td><td>diagnosa_kebidanan</td><td>diagnosa_nama</td><td>action</td>
					</tr>";
					while   ($dl = sqlsrv_fetch_array($hl, SQLSRV_FETCH_ASSOC)){         
						...
						<td>
						<a href='form_asuhan_neonatus_edit.php?id=$id|$user|$dl[id]'>edit</a>
						-
						<a href='implementasi_neonatus.php?id=$id|$user|$noreg|$dl[diagnosa_keperawatan]'>IMPLEMENTASI</a>
						</td>
						</tr>
						";
						$no += 1;
