			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="col-12">
						...
						<tr>
							<td>
								<table>
									...
									<tr>
										<td>Nama pasien</td>
										<td><input type='text' name='abidan1' value='<?php echo $abidan1;?>'></td>
									</tr>
									<tr>
										<td>Umur</td>
										<td><input type='text' name='abidan2' value='<?php echo $abidan2;?>'></td>
									</tr>
									<tr>
										<td>Alamat</td>
										<td><input type='text' name='abidan3' value='<?php echo $abidan3;?>'></td>
									</tr>
									<tr>
										<td>Bahasa</td>
										<td><input type='text' name='abidan4' value='<?php echo $abidan4;?>'></td>
									</tr>
									<tr>
										<td>Suku/Bangsa</td>
										<td><input type='text' name='abidan5' value='<?php echo $abidan5;?>'></td>
									</tr>
									<tr>
										<td>Status Perkawinan</td>
										<td><input type='text' name='abidan6' value='<?php echo $abidan6;?>'></td>
									</tr>
									<tr>
										<td>Berapa kali</td>
										<td><input type='text' name='abidan7' value='<?php echo $abidan7;?>'></td>
									</tr>
									<tr>
										<td>Lama menikah</td>
										<td><input type='text' name='abidan8' value='<?php echo $abidan8;?>'></td>
									</tr>
									<tr>
										<td>Pekerjaan</td>
										<td><input type='text' name='abidan9' value='<?php echo $abidan9;?>'></td>
									</tr>
								</table>
							...
							<td>
								<table>
									<tr>
										<td>No. Reg</td>
										<td><input type='text' name='abidan10' value='<?php echo $abidan10;?>'></td>
									</tr>
									<tr>
										<td>Kelas</td>
										<td><input type='text' name='abidan11' value='<?php echo $abidan11;?>'></td>
									</tr>
									<tr>
										<td>Nama Suami</td>
										<td><input type='text' name='abidan12' value='<?php echo $abidan12;?>'></td>
									</tr>
									<tr>
										<td>Umur</td>
										<td><input type='text' name='abidan13' value='<?php echo $abidan13;?>'></td>
									</tr>
									<tr>
										<td>Alamat</td>
										<td><input type='text' name='abidan14' value='<?php echo $abidan14;?>'></td>
									</tr>
									<tr>
										<td>Bahasa</td>
										<td><input type='text' name='abidan15' value='<?php echo $abidan15;?>'></td>
									</tr>
									<tr>
										<td>Suku/Bangsa</td>
										<td><input type='text' name='abidan16' value='<?php echo $abidan16;?>'></td>
									</tr>
									<tr>
										<td>Status Perkawinan</td>
										<td><input type='text' name='abidan17' value='<?php echo $abidan17;?>'></td>
									</tr>
									<tr>
										<td>Berapa Kali</td>
										<td><input type='text' name='abidan18' value='<?php echo $abidan18;?>'></td>
									</tr>
									<tr>
										<td>Lama Menikah</td>
										<td><input type='text' name='abidan19' value='<?php echo $abidan19;?>'></td>
									</tr>
									<tr>
										<td>Pekerjaan</td>
										<td><input type='text' name='abidan20' value='<?php echo $abidan20;?>'></td>					
									</tr>
								</table>								
							</td>
						</tr>	
					...
					<table>
						...
						<tr>
							<td>
								<table>
									...
									<tr>
										<td>Keluhan Utama</td>
										<td><input type='text' name='abidan21' value='<?php echo $abidan21;?>'></td>
									</tr>
									<tr>
										<td>Riwayat Kehamilan/Penyakit sekarang</td>
										<td><input type='text' name='abidan22' value='<?php echo $abidan22;?>'></td>
									</tr>
									<tr>
										<td>Riwayat Penyakit /Keluarga</td>
										<td><input type='text' name='abidan23' value='<?php echo $abidan23;?>'></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type='text' name='abidan24' value='<?php echo $abidan24;?>'></td>
									</tr>
									<tr>
										<td>Teratur/tidak teratur</td>
										<td><input type='text' name='abidan25' value='<?php echo $abidan25;?>'></td>
									</tr>
									<tr>
										<td>Siklus/hari</td>
										<td><input type='text' name='abidan26' value='<?php echo $abidan26;?>'></td>
									</tr>
									<tr>
										<td>Lamanya</td>
										<td><input type='text' name='abidan27' value='<?php echo $abidan27;?>'></td>
									</tr>
									<tr>
										<td>Banyaknya</td>
										<td><input type='text' name='abidan28' value='<?php echo $abidan28;?>'></td>
									</tr>
									<tr>
										<td>Sifat darah</td>
										<td><input type='text' name='abidan29' value='<?php echo $abidan29;?>'></td>
									</tr>
									<tr>
										<td>Dismenorrhoe</td>
										<td><input type='text' name='abidan30' value='<?php echo $abidan30;?>'></td>
									</tr>
									<tr>
										<td>HPHT</td>
										<td><input type='text' name='abidan31' value='<?php echo $abidan31;?>'></td>
									</tr>
									<tr>
										<td>HPL</td>
										<td><input type='text' name='abidan32' value='<?php echo $abidan32;?>'></td>
									</tr>
									<tr>
										<td>ANC dimana</td>
										<td><input type='text' name='abidan33' value='<?php echo $abidan33;?>'></td>
									</tr>
									<tr>
										<td>Berapa kali</td>
										<td><input type='text' name='abidan34' value='<?php echo $abidan34;?>'></td>
									</tr>
									<tr>
										<td>Status Emosional</td>
										<td><input type='text' name='abidan35' value='<?php echo $abidan35;?>'></td>
									</tr>
									<tr>
										<td>Riwayat KB (Jenis & lamanya)</td>
										<td><input type='text' name='abidan36' value='<?php echo $abidan36;?>'></td>
									</tr>
								</table>
								<input type='submit' name='simpan' value='simpan'>
							</td>
						...
						<tr>
							<td>Riwayat Kehamilan, Pesalinan dan nifas </td>
						</tr>
						<tr>
							<td>
								<table border='1'>
								...
								<table>
									...
									<tr>
										...
										<td>
											...
											<input type='checkbox' name='abidan139' value='YA' <?php if ($abidan139=="YA"){echo "checked";}?> >Obat :  
											Jenis/nama Obat : .<input type='text' name='abidan140' value='<?php echo $abidan140;?>'> 
											...
											<input type='checkbox' name='abidan145' value='YA' <?php if ($abidan145=="YA"){echo "checked";}?> >Lain-lain <input type='text' name='abidan146' value='<?php echo $abidan146;?>'>Reaksi :<input type='text' name='abidan147' value='<?php echo $abidan147;?>'>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											...
											Jenis     : <input type='text' name='abidan157' value='<?php echo $abidan157;?>'>; jumlah <input type='text' name='abidan158' value='<?php echo $abidan158;?>'>
										</td>
									</tr>
								</table>
								<input type='submit' name='simpan' value='simpan'>
								...
								<table border='0'>
									<tr>
										<td style="border: 1px solid;">
											...
											<input type='checkbox' name='abidan158' value='Ya' <?php if ($abidan158=="Ya"){echo "checked";}?> >Ya,    Lokasi :<input type='text' name='abidan159' value='<?php echo $abidan159;?>'><br>
											Sifat :        
											...
											<input type='checkbox' name='abidan164' value='3-4 jam' <?php if ($abidan164=="YA"){echo "checked";}?> >3-4 jam         
											<input type='checkbox' name='abidan164' value='YA' <?php if ($abidan164=="YA"){echo "checked";}?> >> 4 jam
											Selama :  <input type='checkbox' name='abidan164' value='YA' <?php if ($abidan164=="YA"){echo "checked";}?> >< 30 menit   
											<input type='checkbox' name='abidan164' value='YA' <?php if ($abidan164=="YA"){echo "checked";}?> >> 30 menit<br><br>
										...
										<td style="border: 1px solid;">											
											...
											<table>
												<tr>
													...
													<td>
														<input type='checkbox' name='abidan166' value='Normal' <?php if ($abidan166=="YA"){echo "checked";}?> >Normal       
														<input type='checkbox' name='abidan166' value='Serangan awal gangguan bicara' <?php if ($abidan166=="YA"){echo "checked";}?> >Serangan awal gangguan bicara, kapan:<input type='text' name='abidan167' value='<?php echo $abidan167;?>'>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>
														<input type='checkbox' name='abidan176' value='YA' <?php if ($abidan176=="YA"){echo "checked";}?> >Menulis                        <input type='checkbox' name='abidan1' value='YA' <?php if ($abidan1=="YA"){echo "checked";}?> >Audio – Visual / Gambar
														<input type='checkbox' name='abidan176' value='YA' <?php if ($abidan176=="YA"){echo "checked";}?> >Membaca                     
														<input type='checkbox' name='abidan176' value='YA' <?php if ($abidan176=="YA"){echo "checked";}?> >Demonstrasi
														<br>
														<input type='checkbox' name='abidan176' value='YA' <?php if ($abidan176=="YA"){echo "checked";}?> >Mendengar
													</td>
												</tr>
												<tr>
						...
						<tr>
							...
							Gangguan : 
							<input type='checkbox' name='abidan189' value='Tidak' <?php if ($abidan189=="Tidak"){echo "checked";}?>>Tidak
							...
							<input type='checkbox' name='abidan198' value='Tidur/istirahat' <?php if ($abidan1=="Tidur/istirahat"){echo "checked";}?> >Tidur/istirahat
							<input type='checkbox' name='abidan198' value='tidak ada keluhan ' <?php if ($abidan1=="tidak ada keluhan "){echo "checked";}?> >tidak ada keluhan 
							<input type='text' name='abidan199' value='<?php echo $abidan199;?>'>
							<br>
							Aktivitas/latihan dan perawatan diri :
							<input type='checkbox' name='abidan200' value='Mandiri' <?php if ($abidan200=="Mandiri"){echo "checked";}?> >Mandiri        
							<input type='checkbox' name='abidan200' value='Perlu Pengawasan' <?php if ($abidan200=="Perlu Pengawasan"){echo "checked";}?> >Perlu Pengawasan       
							<input type='checkbox' name='abidan200' value='Bantuan sebagian' <?php if ($abidan200=="Bantuan sebagian"){echo "checked";}?> >Bantuan sebagian        
							<input type='checkbox' name='abidan200' value='Bantuan Total' <?php if ($abidan200=="Bantuan Total"){echo "checked";}?> >Bantuan Total
							Alat Bantu :        
							<input type='checkbox' name='abidan201' value='Tidak' <?php if ($abidan201=="Tidak"){echo "checked";}?> >Tidak         
							<input type='checkbox' name='abidan201' value='YA' <?php if ($abidan201=="YA"){echo "checked";}?> >Ya :
						...
						<td>
							...
							<table border='1'>
								<tr>
									...
									<td style="border: 1px solid;">
										<input type='checkbox' name='abidan233' value='Konjungtiva' <?php if ($abidan233=="Konjungtiva"){echo "checked";}?> >Konjungtiva     
								...
								<tr>
									...
									<td style="border: 1px solid;">   
										...
										<br>
										leopold II : <input type='text' name='abidan250' value='<?php echo $abidan250;?>'><br>
										leopold III  : <input type='text' name='abidan251' value='<?php echo $abidan251;?>'><br>
										leopold IV   : <input type='text' name='abidan252' value='<?php echo $abidan252;?>'><br>
										kontaksi uterus :       
										...
										<input type='checkbox' name='abidan256' value='Lama' <?php if ($abidan256=="Lama"){echo "checked";}?> >Lama : <input type='text' name='abidan257' value='<?php echo $abidan257;?>'> detik 
										<br>
										kelainan                     :     
								...
								<tr>
									...
									<td style="border: 1px solid;">
										...
										<input type='checkbox' name='abidan275' value='Kemerahan' <?php if ($abidan275=="Kemerahan"){echo "checked";}?> >Kemerahan									<input type='submit' name='simpan' value='simpan'> 		
									</td>
								</tr>
								<tr>
						...
						<td>
							<table>
								...
								<tr>
									...
									<td>
										<input type='text' name='abidan296' value='<?php echo $abidan296;?>'>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type='text' name='abidan297' value='<?php echo $abidan297;?>'>
									</td>
								</tr>
					...
					<tr>
						<td>
							II. LANGKAH KEDUA<br>
							Identifikasi Diagnosa Masalah dan Kebutuhan <input type='text' name='abidan305' value='<?php echo $abidan305;?>'><br>
							III. IDENTIFIKASI DIAGNOSA DAN ANTISIPASI MASALAH POTENSIAL <input type='text' name='abidan306' value='<?php echo $abidan306;?>'><br>
							IV. KEBUTUHAN AKAN TINDAKAN SEGERA <input type='text' name='abidan307' value='<?php echo $abidan307;?>'><br>

						</td>
					</tr>
					<tr>
						<td>
							Selasai asesmen kebidanan tanggal <input type='text' name='abidan308' value='<?php echo $abidan308;?>'>  jam <input type='text' name='abidan309' value='<?php echo $abidan309;?>'> <br>
							Bidan yang melakukan asesmen<br>


							(<input type='text' name='abidan310' value='<?php echo $abidan310;?>'>)  <br>
							Nama dan Tanda Tangan	<br>
							DPJP<br>



							(<input type='text' name='abidan311' value='<?php echo $abidan311;?>'>)<br>
							Nama dan Tanda Tangan<br>
