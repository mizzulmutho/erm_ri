					...
					<table border='0'>
						<tr>
							<td>
								<h6>D. Persalinan</h6>
								Umur Kehamilan   : 
								<input type='text' name='neo70' value='<?php echo $neo70;?>'> minggu    
								Kehamilan tunggal/kembar : <input type='text' name='neo71' value='<?php echo $neo71;?>'> <br>
								Lama Persalinan <br>
								kala 1 &nbsp;: <input type='text' name='neo72' value='<?php echo $neo72;?>'> jam <input type='text' name='neo73' value='<?php echo $neo73;?>'> menit  <br>     
								Kala II : <input type='text' name='neo74' value='<?php echo $neo74;?>'> jam <input type='text' name='neo75' value='<?php echo $neo75;?>'> menit <br>
								Ketuban pecah sebelum lahir <input type='text' name='neo76' value='<?php echo $neo76;?>'> jam &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='neo77' value='<?php echo $neo77;?>'> menit, <br>
								Air ketuban : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jumlah <input type='text' name='neo78' value='<?php echo $neo78;?>'> cc warna/bau &nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='neo79' value='<?php echo $neo79;?>'> <br>
								Letak bayi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type='text' name='neo80' value='<?php echo $neo80;?>'> jenis persalinan <input type='text' name='neo81' value='<?php echo $neo81;?>'> Indikasi Persalinan operatif <input type='text' name='neo82' value='<?php echo $neo82;?>'><br>
