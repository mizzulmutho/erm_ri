		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-12">
						<center>
							<b>RINGKASAN PASIEN MASUK DAN KELUAR RUMAH SAKIT</b>
						</center>
						<hr>
						<?php
						$q2       = "
						...
						echo "Diisi Oleh Petugas : ";echo "<br>";
						echo '<table><tr>';
						...
						echo '<table>';
						echo '<tr>';
						echo '<td>Petugas yang menerima'.'</td><td>: </td>';
						echo '<td>Tanda Tangan'.'</td><td>: </td></tr>';						
						echo '</tr>';
						echo '</table>';

						echo "<br>";
						echo "Diisi Oleh dokter/DPJP : ";echo "<br>";
						echo '<table>';
						echo '<tr>';
						echo '<td>Tgl Keluar'.'</td><td>: </td>';
						echo '<td>Diagnosa Keluar'.'</td><td>: </td></tr>';						
						echo '</tr>';
						echo '<tr>';
						echo '<td>Diagnosa Utama'.'</td><td>: </td>';
						echo '<td>Diagnosa Sekunder'.'</td><td>: </td></tr>';						
						echo '</tr>';
						echo '<tr>';
						echo '<td>Cara Keluar '.'</td><td>: </td>';
						echo '<td>Keadaan Waktu Keluar'.'</td><td>: </td></tr>';						
						echo '</tr>';
						echo '<tr>';
						echo '<td>Dokter yang memulangkan'.'</td><td>: </td>';
						echo '<td>Tanda Tangan'.'</td><td>: </td></tr>';						
						echo '</tr>';
