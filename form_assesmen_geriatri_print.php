	...
	<body onload="document.myForm.td_sistolik.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						<b><center>ASESMEN AWAL KEPERAWATAN GERIATRI</center></b>
					</div>
				</div>
				...
				<div class="col-12">
					<table  class="table table-bordered">
						<tr>
							<td colspan='2'><b>DIISI OLEH PERAWAT</b>
								&nbsp;&nbsp;&nbsp;<input disabled class="" name="tglinput" value="<?php echo $tglinput;?>" type="text" >
							</td>
						</tr>
						<tr>
							<td width="70%">
							...
							<td colspan='2'>
								<table border="0">
									...
									<tr>
										...
										<td>: 
											<!-- <input disabled type='text' name='riwayat_penyakit_sekarang' value='<?php echo $riwayat_penyakit_sekarang;?>'> -->
									...
									<tr>
										...
										<td>: <input disabled type='checkbox' name='obat_sedang_dikonsumsi' value='Tidak ada' <?php if ($obat_sedang_dikonsumsi=="Tidak ada"){echo "checked";}?>>Tidak ada <input disabled type='checkbox' name='obat_sedang_dikonsumsi' value='Ada' <?php if ($obat_sedang_dikonsumsi=="Ada"){echo "checked";}?>>Ada, tulis di form, <a href='rekon_obat.php?id=<?php echo $id.'|'.$user;?>'>Rekonsiliasi Obat</a></td>
									</tr>
									<tr>
							...
							<td>
								...
								<table border="0">
									...
									<tr>
										<td><b>GCS</b></td>
										<td coslpan='2'> 
											E : <input disabled type='text' name='ku_gcs_e' value='<?php echo $ku_gcs_e;?>'>
											V : <input disabled type='text' name='ku_gcs_v' value='<?php echo $ku_gcs_v;?>'>
											M : <input disabled type='text' name='ku_gcs_m' value='<?php echo $ku_gcs_m;?>'>
										</td>
									</tr>
									<tr><td>Suhu</td>
										<td colspan='2'>
							...
							<td>
								...
								<table border="0">
									...
									<tr>
										<td>Suara Jantung</td>
										<td coslpan='2'>:
											<input disabled type='checkbox' name='ku_suara_jantung' value='Tidak ada kelainan' <?php if ($ku_suara_jantung=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan<input disabled type='checkbox' name='ku_suara_jantung' value='kelainan' <?php if ($ku_suara_jantung=="kelainan"){echo "checked";}?>>ada kelainan
										</td>
									</tr>
									<tr>
										<td>Akral</td>
					...
					<tr>
						<td>
							...
							<br>
							DPJP : <input disabled class="" name="dpjp" value="<?php echo $dpjp;?>" id="dokter" type="text" size='80' onfocus="nextfield ='';" placeholder="Isikan Nama Dokter atau Kode Dokter">&nbsp;&nbsp;&nbsp;
							<br>
							<br>
							<br>
							...
							<table border='0' width="100%">
								...
								<tr>
									<td align="center">
										<?php $verif_perawat="Document ini telah diVerifikasi Oleh : ".$user."Pada Tanggal : ".$tgl_assesment;?>
