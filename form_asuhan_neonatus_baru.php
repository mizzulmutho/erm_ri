...
if (isset($_POST["simpan_rencana"])) {
	...
	//jika tidak ada insert
		...
		('$id','$noreg','$diagnosa_kode','$tgl','$user','$data','$diagnosa_nama','RENCANA ASUHAN NEONATUS')";         
		$hs = sqlsrv_query($conn,$q);
