			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						...
						<a href='form_assesmen_geriatri_print.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-info' target='_blank'><i class="bi bi-printer-fill"></i></a>	
						&nbsp;&nbsp;
						<i class="bi bi-window-plus"> &nbsp; <b>ASESMEN AWAL KEPERAWATAN GERIATRI</b></i>
						...
						<td colspan='2'>
							<table border="0">
								...
								<tr>
									...
									<td>: 
										<!-- <input type='text' name='riwayat_penyakit_sekarang' value='<?php echo $riwayat_penyakit_sekarang;?>'> -->
						...
						<td>
							...
							<table border="0">
								...
								<tr>
									<td>Penggunaan alat medis</td>
									<td coslpan='2'>:
										<input type='Ya' name='ku_irkulasi_alat_medis' value='Tidak' <?php if ($ku_irkulasi_alat_medis=="Tidak"){echo "checked";}?>>Tidak
										<input type='Ya' name='ku_irkulasi_alat_medis' value='Ya' <?php if ($ku_irkulasi_alat_medis=="Ya"){echo "checked";}?>>Ya, 
...
<!-- 					<input type='checkbox' name='ku_nyerimasalah7' value='Hipervolemia' <?php if ($ku_nyerimasalah7=="Hipervolemia"){echo "checked";}?>> Hipervolemia<br>
			...
			<tr>
				<td>
					...
					<input type='radio' name='aktivitas1' value='Tidur/istirahat' <?php if ($aktivitas1=="Tidur/istirahat"){echo "checked";}?>>Tidur/istirahat   
					<input type='radio' name='aktivitas1' value='Tidak ada keluhan' <?php if ($aktivitas1=="Tidak ada keluhan"){echo "checked";}?>>Tidak ada keluhan<br> 
		...
		<tr>
			<td>
				...
				pasien kooperatif :   
				<input type='radio' name='asdewasa3' value='Ya' <?php if ($asdewasa3=="Ya"){echo "checked";}?>>Ya       
				<input type='radio' name='asdewasa3' value='Tidak' <?php if ($asdewasa3=="Tidak"){echo "checked";}?>>Tidak<br>
		...
		<tr>
			<td>
				...
				<input type='radio' name='asdewasa5' value='Ada kelainan' <?php if ($asdewasa5=="Ada kelainan"){echo "checked";}?>>Ada kelainan :<br>
				Gangguan istirahat    :    
				...
				<table border='0' width="100%">
					...
					<tr>
						<td align="center">
							...
							<?php 
							QRcode::png($verif_perawat, "asger1.png", "L", 2, 2);   
						...
						<td align="center">
							...
							if($tgl_verif){
								QRcode::png($verif_dpjp, "asger2.png", "L", 2, 2);   
								echo "<center><img src='asger2.png'></center>";
							}
							echo $dpjp;
							?>										
						</td>
...
if (isset($_POST["simpan"])) {
	...
	if($lanjut=='Y'){
		...
		tjatuh12='$tjatuh12',
		tjatuh13='$tjatuh13',
		tjatuh14='$tjatuh14',tjatuh15='$tjatuh15',tjatuh16='$tjatuh16',tjatuh17='$tjatuh17',
		asdewasa1='$asdewasa1',
		asdewasa2='$asdewasa2',
		asdewasa3='$asdewasa3',
		asdewasa4='$asdewasa4',
