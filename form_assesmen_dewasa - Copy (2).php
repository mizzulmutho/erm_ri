				...
				<div class="row">
					<div class="col-12">
						<table class="table table-bordered">
							...
							<tr>
								<td>Riwayat Alergi</td><td>: <?php echo $alergi;?></td>
							</tr>
						</table>
					</div>
				</div>
					...
					<table  class="table table-bordered">
						<tr>
							<td colspan='2'><b>DIISI OLEH PERAWAT</b> 
								&nbsp;&nbsp;&nbsp;<input class="" name="tglinput" value="<?php echo $tglinput;?>" type="text" ></td>
							</tr>
							<tr>
								<td width="70%">
								...
								<td colspan='2'>
									<table border="0">
										<tr>
											...
											<td>: <input type='text' name='keluhan_pasien' value='<?php echo $keluhan_pasien;?>'></td>
										</tr>
										<tr>
											<td>Riwayat penyakit sekarang</td>
											<td>: 
												<!-- <input type='text' name='riwayat_penyakit_sekarang' value='<?php echo $riwayat_penyakit_sekarang;?>' size='80'> -->
												<textarea name= "riwayat_penyakit_sekarang" id="fisik" style="min-width:630px; min-height:80px;"><?php echo $riwayat_penyakit_sekarang;?></textarea>
											</td>
										</tr>
										<tr>
											<td>Riwayat penyakit dahulu</td>
											<td>: 
												<!-- <input type='text' name='riwayat_penyakit_dahulu' value='<?php echo $riwayat_penyakit_dahulu;?>'> -->
										...
										<tr>
											...
											<td>: <input type='text' name='riwayat_penyakit_keluarga' value='<?php echo $riwayat_penyakit_keluarga;?>'></td>
										</tr>
										<tr>
											<td>Obat yang sedang dikonsumsi</td>
											<td>: <input type='checkbox' name='obat_sedang_dikonsumsi' value='Tidak ada' <?php if ($obat_sedang_dikonsumsi=="Tidak ada"){echo "checked";}?>>Tidak ada <input type='checkbox' name='obat_sedang_dikonsumsi' value='Ada' <?php if ($obat_sedang_dikonsumsi=="Ada"){echo "checked";}?>>Ada, tulis di form, Rekonsiliasi Obat</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>: <input type='checkbox' name='riwayat_tranfusi_darah' value='Tidak' <?php if ($riwayat_tranfusi_darah=="Tidak"){echo "checked";}?>>Tidak
												<input type='checkbox' name='riwayat_tranfusi_darah' value='Ya' <?php if ($riwayat_tranfusi_darah=="Ya"){echo "checked";}?>>Ya
											</td>
										</tr>
										<tr>
											<td>Reaksi Alergi</td>
											<td>: <input type='checkbox' name='reaksi_alergi' value='Tidak' <?php if ($reaksi_alergi=="Tidak"){echo "checked";}?>>Tidak 
												<input type='checkbox' name='reaksi_alergi' value='Ya' <?php if ($reaksi_alergi=="Ya"){echo "checked";}?>>Ya 
												<input type='text' name='ket_reaksi_alergi' value='<?php echo $ket_reaksi_alergi;?>'>
											</td>
										</tr>
										<tr>
											<td>Riwayat merokok</td>
											<td>: <input type='text' name='riwayat_merokok' value='<?php echo $riwayat_merokok;?>'>
											</td>
										</tr>
										<tr>
											<td>Riwayat minum minuman keras</td>
											<td>: <input type='text' name='riwayat_minuman_keras' value='<?php echo $riwayat_minuman_keras;?>'>
											</td>
										</tr>
										<tr>
											<td>Riwayat pergi keluar negeri</td>
											<td>: <input type='text' name='riwayat_keluar_negri' value='<?php echo $riwayat_keluar_negri;?>'>
											</td>
										</tr>
									</table>							
									<input type='submit' name='simpan' value='simpan'>			
							...
							<tr>
									...
									<table border="0">
										...
										<tr>
											...
											<td coslpan='2'> 
												...
												M : <input type='text' name='ku_gcs_m' value='<?php echo $ku_gcs_m;?>' size='5'><br>
												Total : <input type='text' name='total_gcs' value='<?php echo $total_gcs;?>' size='5'>
											</td>
										</tr>
										<tr><td>Berat Badan</td>
											<td colspan='2'>
												<input type='text' name='ku_beratbadan' value='<?php echo $ku_beratbadan;?>' size='5'>
												Tinggi Badan &nbsp;&nbsp;&nbsp;: 
												<input type='text' name='ku_tinggibadan' value='<?php echo $ku_tinggibadan;?>' size='5'>
											</td>
										</tr>
										<tr><td>Suhu</td>
											<td colspan='2'>
								...
								<td>
									...
									if($de[m1]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m1t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m1t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m1y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>										
							...
							<tr>
									...
									<table border="0">
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_respirasi_dada' value='Simetris' <?php if ($ku_respirasi_dada=="Simetris"){echo "checked";}?>>Simetris
											</td>
										</tr>
										<tr>
											<td>Pola nafas</td>
										...
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_otot_bantu_nafas' value='Ya' <?php if ($ku_otot_bantu_nafas=="Ya"){echo "checked";}?>>Ya
											</td>
										</tr>
										<tr>
											<td>Batuk</td>
								...
								<td>
									...
									if($de[m2]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m2t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m2t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m2y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>		
							...
							<tr>
									...
									<table border="0">
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_irkulasi_jantung' value='Ireguler' <?php if ($ku_irkulasi_jantung=="Ireguler"){echo "checked";}?>>Ireguler
											</td>
										</tr>
										<tr>
											<td>Suara Jantung</td>
											<td coslpan='2'>:
												<input type='checkbox' name='ku_suara_jantung' value='Normal' <?php if ($ku_suara_jantung=="Normal"){echo "checked";}?>>Normal 
												<input type='checkbox' name='ku_suara_jantung' value='Tidak ada kelainan' <?php if ($ku_suara_jantung=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada 
												<input type='checkbox' name='ku_suara_jantung' value='kelainan' <?php if ($ku_suara_jantung=="kelainan"){echo "checked";}?>>kelainan
											</td>
										</tr>
										<tr>
											<td>Akral</td>
											<td coslpan='2'>:
												...
												CRT: <input type='text' name='ku_kelainan_jantung_crt' value='<?php echo $ku_kelainan_jantung_crt;?>'>
											</td>
										</tr>
										<tr>
											<td>Anemis</td>
										...
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_irkulasi_vena' value='Ya' <?php if ($ku_irkulasi_vena=="Tidak"){echo "checked";}?>> Ya
											</td>
										</tr>
										<tr>
											<td>Penggunaan alat medis</td>
								...
								<td>
									...
									if($de[m3]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m3t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m3t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m3y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>		
									...
									<table border="0">
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_fisiologis' value='Biseps' <?php if ($ku_persepsi_fisiologis=="Biseps"){echo "checked";}?>>Biseps
											</td>
										</tr>
										<tr>
											...
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_patologis' value='Kerning' <?php if ($ku_persepsi_patologis=="Kerning"){echo "checked";}?>>Kerning
											</td>
										</tr>
										<tr>
											<td>Mata</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_mata' value='Strabismus' <?php if ($ku_persepsi_mata=="Strabismus"){echo "checked";}?>>Strabismus
											</td>
										</tr>
										<tr>
											<td>Pupil</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_pupil' value='Reaksi Cahaya' <?php if ($ku_persepsi_pupil=="Reaksi Cahaya"){echo "checked";}?>>Reaksi Cahaya
											</td>
										</tr>
										<tr>
											<td>Telinga</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_telinga' value='Tinitus' <?php if ($ku_persepsi_telinga=="Tinitus"){echo "checked";}?>>Tinitus
											</td>
										</tr>
										<tr>
											<td>Hidung</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_hidung' value='Tersumbat' <?php if ($ku_persepsi_hidung=="Tersumbat"){echo "checked";}?>>Tersumbat
											</td>
										</tr>
										<tr>
											<td>Sensibilitas</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_bicara' value='Afasia' <?php if ($ku_persepsi_bicara=="Afasia"){echo "checked";}?>>Afasia
											</td>
										</tr>
										<tr>
											<td>Kaku kuduk</td>
											<td coslpan='2'>:
												...
												<input type='checkbox' name='ku_persepsi_kaku_duduk' value='Ya' <?php if ($ku_persepsi_kaku_duduk=="Ya"){echo "checked";}?>>Ya
											</td>
										</tr>
										<tr>
							...
							<tr>
								<td>
									...
									<table class="">
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri1' value='Tak ada ekspresi' <?php if ($ku_tnyeri1=="Tak ada ekspresi"){echo "checked";}?>>Tak ada ekspresi</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri1' value='Menyeringai' <?php if ($ku_tnyeri1=="Menyeringai"){echo "checked";}?>>Menyeringai</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri1' value='Dagu gemetar & rahang dikatup erat' <?php if ($ku_tnyeri1=="Dagu gemetar & rahang dikatup erat"){echo "checked";}?>>Dagu gemetar & rahang dikatup erat</td>
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri2' value='Normal' <?php if ($ku_tnyeri2=="Normal"){echo "checked";}?>>Normal</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri2' value='Gelisah tenang' <?php if ($ku_tnyeri2=="Gelisah tenang"){echo "checked";}?>>Gelisah tenang</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri2' value='Menendang/ melawan' <?php if ($ku_tnyeri2=="Menendang/ melawan"){echo "checked";}?>>Menendang/ melawan</td>
											<td style="border: 1px solid;">
												<?php 
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri3' value='Tidur tenang' <?php if ($ku_tnyeri3=="Tidur tenang"){echo "checked";}?>>Tidur tenang</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri3' value='Menggeliat tenang' <?php if ($ku_tnyeri3=="Menggeliat tenang"){echo "checked";}?>>Menggeliat tenang</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri3' value='Menekuk, kaku' <?php if ($ku_tnyeri3=="Menekuk, kaku"){echo "checked";}?>>Menekuk, kaku</td>
											<td style="border: 1px solid;">
												<?php 
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri4' value='Tidur , tak ada tangisan' <?php if ($ku_tnyeri4=="Tidur , tak ada tangisan"){echo "checked";}?>>Tidur , tak ada tangisan</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri4' value='Mengerang, merengek' <?php if ($ku_tnyeri4=="Mengerang, merengek"){echo "checked";}?>>Mengerang, merengek</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri4' value='Menangis, menjerit' <?php if ($ku_tnyeri4=="Menangis, menjerit"){echo "checked";}?>>Menangis, menjerit</td>
											<td style="border: 1px solid;">
												<?php 
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri5' value='Santai, nyaman' <?php if ($ku_tnyeri5=="Santai, nyaman"){echo "checked";}?>>Santai, nyaman</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri5' value='Dipastikan dengan sentuhan' <?php if ($ku_tnyeri5=="Dipastikan dengan sentuhan"){echo "checked";}?>>Dipastikan dengan sentuhan</td>
											<td style="border: 1px solid;"><input type='checkbox' name='ku_tnyeri5' value='Sulit konsul / tidak nyaman' <?php if ($ku_tnyeri5=="Sulit konsul / tidak nyaman"){echo "checked";}?>>Sulit konsul / tidak nyaman</td>
											<td style="border: 1px solid;">
												<?php 
								...
								<td>
									...
									if($de[m4]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m4t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m4t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m4y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>		
							...
							<tr>
								...
								<td>
									...
									if($de[m5]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m5t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m5t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m5y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m6]){
										...
										<input type='checkbox' name='ku_nyerimasalah10' value='Defisit Nutrisi<' <?php if ($ku_nyerimasalah10=="Defisit Nutrisi<"){echo "checked";}?>> Defisit Nutrisi
											<br>
											...
											<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m6t'; ?>" style='text-decoration: none;color:black';><br>
											&#9744; Tidak Ada masalah</a>
										<?php }else{
											?>	
											<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m6t'; ?>" style='text-decoration: none;color:black';>
											&#9745; Tidak Ada masalah</a><br>
											<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m6y'; ?>" style='text-decoration: none;color:black';>
											&#9744; Ada masalah</a>
											<?php
										}
										?>	
								...
								<td>
									...
									if($de[m7]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m7t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m7t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m7y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m8]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m8t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m8t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m8y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m9]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m9t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m9t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m9y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m10]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m10t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m10t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m10y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m11]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m11t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m11t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m11y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m12]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m12t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m12t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m12y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
							...
							<tr>
								...
								<td>
									...
									if($de[m13]){
										...
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m13t'; ?>" style='text-decoration: none;color:black';><br>
										&#9744; Tidak Ada masalah</a>
									<?php }else{
										?>	
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m13t'; ?>" style='text-decoration: none;color:black';>
										&#9745; Tidak Ada masalah</a><br>
										<a href="form_assesmen_dewasa.php?id=<?php echo $id.'|'.$user.'|'.'m13y'; ?>" style='text-decoration: none;color:black';>
										&#9744; Ada masalah</a>
										<?php
									}
									?>	
								...
								<td>
									...
									<table>
										...
										<tr>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa20' value='Ya' <?php if ($asdewasa20=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa20' value='Tidak' <?php if ($asdewasa20=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">2</td>
											<td style="border: 1px solid;">Tinggal sendirian tanpa dukungan sosial secara langsung</td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa21' value='Ya' <?php if ($asdewasa21=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa21' value='Tidak' <?php if ($asdewasa21=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">3</td>
											...
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa22' value='Ya' <?php if ($asdewasa22=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa22' value='Tidak' <?php if ($asdewasa22=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">4</td>
											<td style="border: 1px solid;">Korban dari kasus criminal</td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa23' value='Ya' <?php if ($asdewasa23=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa23' value='Tidak' <?php if ($asdewasa23=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">5</td>
											<td style="border: 1px solid;">Trauma Multiple</td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa24' value='Ya' <?php if ($asdewasa24=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa24' value='Tidak' <?php if ($asdewasa24=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">6</td>
											<td style="border: 1px solid;">Memerlukan Perawatan atau pengobatan berkelanjutan</td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa25' value='Ya' <?php if ($asdewasa25=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa25' value='Tidak' <?php if ($asdewasa25=="Tidak"){echo "checked";}?>></td>
										</tr>
										<tr>
											<td style="border: 1px solid;">7</td>
											<td style="border: 1px solid;">Pasien lansia yang ada dilantai atas (saat dirumah)</td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa26' value='Ya' <?php if ($asdewasa26=="Ya"){echo "checked";}?>></td>
											<td style="border: 1px solid;"><input type='checkbox' name='asdewasa26' value='Tidak' <?php if ($asdewasa26=="Tidak"){echo "checked";}?>></td>
										</tr>
							...
							<tr>
								<td>
									<br>
									DPJP : <input class="" name="dpjp" value="<?php echo $dpjp;?>" id="dokter" type="text" size='30' onfocus="nextfield ='';" placeholder="Isikan Nama Dokter atau Kode Dokter">&nbsp;&nbsp;&nbsp;<input type='submit' name='simpan' value='simpan'>
									<br>
									<br>
									<br>
									...
									<table border='0' width="100%">
										...
										<tr>
											<td align="center">
												...
												<center><img alt='testing' src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=$verif_perawat&choe=UTF-8'/></center>
												<br>
												<?php echo $userid;?>
											</td>
											<td align="center">
