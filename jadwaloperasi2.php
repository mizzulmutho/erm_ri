...
$qi="SELECT noreg FROM ERM_RI_LAPORAN_OK2 where noreg='$noreg'";
$hi  = sqlsrv_query($conn, $qi);        
$di  = sqlsrv_fetch_array($hi, SQLSRV_FETCH_ASSOC); 
$regcek = $di['noreg'];

if(empty($regcek)){
	$q  = "insert into ERM_RI_LAPORAN_OK2(noreg,userid,tglentry,tgl) values ('$noreg','$user','$tgl','$tgl')";
		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					&nbsp;&nbsp;
					<a href='jadwal_operasi_list2.php?id=<?php echo $id.'|'.$user; ?>' class='btn btn-success'><i class="bi bi-box-arrow-in-right"></i> Template</a>
					&nbsp;&nbsp;
					<!-- <a href='#' class='btn btn-info'>Print</a> -->
					<a href='jadwaloperasi2_print.php?id=<?php echo $id.'|'.$user; ?>' class='btn btn-info' target='_blank'><i class="bi bi-printer-fill"></i></a>
					&nbsp;&nbsp;
					<a href='jadwaloperasi.php?id=<?php echo $id.'|'.$user; ?>' class='btn btn-info'>Hal.1</a>
					&nbsp;&nbsp;
					<a href='' class='btn btn-light'>Hal.2</a>
					&nbsp;&nbsp;
					<a href='jadwaloperasi3.php?id=<?php echo $id.'|'.$user; ?>' class='btn btn-info'>Hal.3</a>
					&nbsp;&nbsp;
					<br>
					<br>
<!-- 				<div class="row">
					...
					<td colspan="2">
						<div class="row">
							<div class="col-12">
								Upload Gambar : 
								<?php 
								$q		= "select doc as doc from ERM_RI_LAPORAN_OK2 where noreg = '$noreg'";
...
if (isset($_POST["upload"])) {
	...
	$q  = "update ERM_RI_LAPORAN_OK2 set doc='$path' where noreg='$noreg'";         
	$hs = sqlsrv_query($conn,$q);
...
if (isset($_POST["simpan"])) {
	...
	$q  = "update ERM_RI_LAPORAN_OK2 set
	ok1	='$ok1',
	ok2	='$ok2',
	ok3	='$ok3',
	ok4	='$ok4',
