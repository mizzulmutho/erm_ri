	...
	<body onload="document.myForm.td_sistolik.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				&nbsp;&nbsp;
				<a href='observasi_cairan.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success btn-sm'><i class="bi bi-list"></i> Monitoring Cairan</a>
				<br><br>
						...
						<table border='0' width="100%">
							...
							<tr><td>GCS </td>
								<td>: 
									...
									E <input class="" name="ob3" value="<?php echo $ob3;?>" id="ob3" type="text" size='2' placeholder=""> 
									V <input class="" name="ob4" value="<?php echo $ob4;?>" id="ob4" type="text" size='2' placeholder="">
									M <input class="" name="ob5" value="<?php echo $ob5;?>" id="ob5" type="text" size='2' placeholder="">
									Total <input class="" name="ob6" value="<?php echo $ob6;?>" id="ob6" type="text" size='2' placeholder="" readonly>
			...
			<div class="row">
				<div class="col-6">
					<center>
						<button type='submit' name='simpan' value='simpan' class="btn btn-info" type="button" style="height: 50px;width: 300px;"><i class="bi bi-save-fill"></i> Simpan Monitoring EWS</button>
					</center>
				</div>
			</div>
...
<div class="row">
	<div class="col-12">
		<center>
			<button type='submit' name='simpan' value='simpan' class="btn btn-info" type="button" style="height: 50px;width: 250px;"><i class="bi bi-save-fill"></i> Simpan Monitoring Cairan</button>
		</center>
	</div>
</div>
