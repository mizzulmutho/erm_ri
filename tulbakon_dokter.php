	...
	<body onload="document.myForm.kodedokter.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						<i class="bi bi-window-plus"> &nbsp; <b>INPUT TULBAKON / SBAR di CPPT</b></i>
					</div>
				</div>
				<hr>
<!-- 				<div class="row">
				...
				<div class="row">
					<div class="col-2">
						<label for="" class="col-sm-2">DOKTER</label>
					</div>					
					<div class="col-10">
						<input class="form-control" name="kodedokter" value="<?php echo $kodedokter;?>" id="dokter" type="text" size='50' onfocus="nextfield ='simpan';" placeholder="Isikan Nama Dokter">
					</div>										
				</div>
				<br><br>
				<div class="row">
...
if (isset($_POST["simpan"])) {
	...
	if($lanjut == 'Y'){
		...
		$q  = "insert into ERM_TULBAKON
		(idsoap, noreg, dokter, tglentry, userid, namadokter) 
		values 
