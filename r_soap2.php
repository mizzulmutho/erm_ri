		...
		<font size='2px'>
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<table  class="table table-bordered">
					...
					CONVERT(VARCHAR, tglinput, 103) as tgl2, 
					...
					UNION
					SELECT        TOP (100) id, '' AS kodedokter, noreg, userid as userinput, '' AS dpjp, '' AS subjektif, '' AS objektif, '' AS assesment, '' AS planning, '' AS instruksi, '' AS sbu, '' AS kodeunit, CONVERT(VARCHAR, tgl, 103) AS tgl2, CONVERT(VARCHAR, 
						tglentry, 8) AS tgl3, CONVERT(VARCHAR, tglentry, 20) AS tgl4, 'NYERI' AS jenis,'' as instruksi
					FROM            ERM_RI_NYERI
					WHERE        (noreg = '$noreg')
					UNION
					SELECT        TOP (100) id, '' AS kodedokter, noreg, userid AS userinput, '' AS dpjp, '' AS subjektif, '' AS objektif, '' AS assesment, '' AS planning, '' AS instruksi, '' AS sbu, '' AS kodeunit, CONVERT(VARCHAR, tgl, 103) AS tgl2, 
