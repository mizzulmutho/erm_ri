...
<!-- 				<div class="row">
			...
			<div class="row">
				<div class="col-6">
					...
					<textarea class="form-control" name="am1" cols="100%" onfocus="nextfield ='';" style="min-height:30px;"><?php echo $am1;?></textarea>
					...
					<textarea class="form-control" name="am2" cols="100%" onfocus="nextfield ='';" style="min-height:30px;"><?php echo $am2;?></textarea>
					...
					<textarea class="form-control" name="am3" cols="100%" onfocus="nextfield ='';" style="min-height:30px;"><?php echo $am3;?></textarea>
					...
					<textarea class="form-control" name="am4" cols="100%" onfocus="nextfield ='';" style="min-height:30px;"><?php echo $am4;?></textarea>
