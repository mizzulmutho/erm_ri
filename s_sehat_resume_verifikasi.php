...
echo "Sedang Proses Mohon ditunggu jangan di Close !!!!";
echo "<br>";

if($jenis=='resep'){

    //IDPERESEPAN_MEDICATION
...
//IDPENGELUARANOBAT_MEDICATIONDISPENCE
...
if($jenis=='rawat'){
    ...
    $rencana_rawat = str_replace("'","`",$rencana_rawat);   
    $rencana_rawat = str_replace("+","",$rencana_rawat);   
    $rencana_rawat = str_replace("/","",$rencana_rawat);   
    $rencana_rawat = str_replace("ï¿½","",$rencana_rawat);   
...
<script>
alert('".$eror."');
window.location.replace('resume_approval.php?id=$id2|$user');
</script>
";
