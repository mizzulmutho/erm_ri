...
$qi="SELECT noreg,tr1 FROM ERM_RI_TRANSFER where noreg='$noreg'";
...
if(empty($regcek)){
	$q  = "insert into ERM_RI_TRANSFER(noreg,userid,tglentry,tgl) values ('$noreg','$user','$tglentry','$tgl')";
	$hs = sqlsrv_query($conn,$q);
}else{

	if($idtransfer and empty($tr1)){
		$qe="
		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<font size='3px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					&nbsp;&nbsp;
					<a href='http://192.168.10.194:3010/rekam_medik/entry_erm/rawat_ok/<?php echo $KODEUNIT;?>/<?php echo $noreg;?>/<?php echo $norm;?>/timbangterima' class='btn btn-success' target='_blank'><i class="bi bi-box-arrow-in-right"></i> Transfer ke OK</a>
					&nbsp;&nbsp;
					<a href='transfer_pasien.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success'><i class="bi bi-box-arrow-in-right"></i> Transfer ke Unit</a>
					&nbsp;&nbsp;
				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-8">
								<!-- <input class="" name="tr1" value="<?php echo $tr1;?>" id="" type="text" size='30' placeholder=""> -->
								<?php 
								if($tr1){
									echo "<input type='text' name='tr1' value='$tr1' size='30'>";
								}else{
									echo "
									<select name='tr1' style='min-width:250px; min-height:30px;''>
								...
								?>
								&nbsp;&nbsp;&nbsp;
								Ke Unit <input class="" name="tr2" value="<?php echo $tr2;?>" id="keunit" type="text" size='40' placeholder="">
							</div>
						</div>
					</td>
				</tr>	
