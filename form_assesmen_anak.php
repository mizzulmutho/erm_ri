							...
							<td>
								<table>
									...
									<tr>
										<td>Masuk Ke RS :</td>
										<td colspan="2">
											<input type='checkbox' name='asanak11' value='Datang sendiri' <?php if ($asanak11=="Datang sendiri"){echo "checked";}?>>Datang sendiri  
											<input type='checkbox' name='asanak11' value='Diantar keluarga' <?php if ($asanak11=="Diantar keluarga"){echo "checked";}?>>        
											Diantar keluarga      
										</td>
									</tr>
									<tr>
							...
							<td colspan='2'>
								<table border="0">
									...
									<tr>
										...
										<td>: 
											<!-- <input type='text' name='riwayat_penyakit_keluarga' value='<?php echo $riwayat_penyakit_keluarga;?>'> -->
	...
	<td>
		...
		<table border="0">
			<tr>
				<td>Kepala</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak38' value='Tidak ada kelainan ' <?php if ($asanak38=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak38' value='Ada kelainan' <?php if ($asanak38=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Wajah</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak39' value='Tidak ada kelainan ' <?php if ($asanak39=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak39' value='Ada kelainan' <?php if ($asanak39=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
					<input type='text' name='' value=''>
				</td>
			</tr>
			<tr>
				<td>Mata</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak40' value='Tidak ada kelainan ' <?php if ($asanak40=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak40' value='Ada kelainan' <?php if ($asanak40=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Telinga</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak42' value='Tidak ada kelainan ' <?php if ($asanak42=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak42' value='Ada kelainan' <?php if ($asanak42=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Hidung</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak44' value='Tidak ada kelainan ' <?php if ($asanak44=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak44' value='Ada kelainan' <?php if ($asanak44=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Mulut</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak46' value='Tidak ada kelainan ' <?php if ($asanak46=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak46' value='Ada kelainan' <?php if ($asanak46=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Leher</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak48' value='Tidak ada kelainan ' <?php if ($asanak48=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak48' value='Ada kelainan' <?php if ($asanak48=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Dada</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak50' value='Tidak ada kelainan ' <?php if ($asanak50=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak50' value='Ada kelainan' <?php if ($asanak50=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Perut</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak52' value='Tidak ada kelainan ' <?php if ($asanak52=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak52' value='Ada kelainan' <?php if ($asanak52=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
			...
			<tr>
				<td>Anggota Gerak</td>
				<td coslpan='2'>:
					<input type='radio' name='asanak54' value='Tidak ada kelainan ' <?php if ($asanak54=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
					<input type='radio' name='asanak54' value='Ada kelainan' <?php if ($asanak54=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
...
<!-- 									<tr>
									...
									<tr>
										<td>Kulit</td>
										<td coslpan='2'>:
											<input type='radio' name='asanak58' value='Tidak ada kelainan ' <?php if ($asanak58=="Tidak ada kelainan "){echo "checked";}?>>Tidak ada kelainan  
											<input type='radio' name='asanak58' value='Ada kelainan' <?php if ($asanak58=="Ada kelainan"){echo "checked";}?>>Ada kelainan : 
							...
							<td>
<!-- 								<input type='checkbox' name='asanak207' value='Bersihan jalan napas tidak efektif' <?php if ($asanak207=="Bersihan jalan napas tidak efektif"){echo "checked";}?>>Bersihan jalan napas tidak efektif<br>
						...
						<td>
							...
							<table border="0">
								<tr>
									...
									<td coslpan='2'><input type='text' name='r_hamil1' value='<?php echo $r_hamil1;?>'>
									</td>
								</tr>
								<tr>
									<td>Gravida ke  </td>
									<td coslpan='2'><input type='text' name='r_hamil2' value='<?php echo $r_hamil2;?>'>
									</td>
								</tr>
								<tr>
									<td>Gangguan Hamil (Trimester 1) </td>
									<td coslpan='2'><input type='text' name='r_hamil3' value='<?php echo $r_hamil3;?>'>
									</td>
								</tr>
								<tr>
									<td>Type Persalinan</td>
									<td coslpan='2'>
										<input type='radio' name='type_persalinan1' value='Spontan' <?php if ($type_persalinan1=="Spontan"){echo "checked";}?>>
										Spontan  
										<input type='radio' name='type_persalinan2' value='Induksi' <?php if ($type_persalinan2=="Induksi"){echo "checked";}?>>
										Induksi
										<input type='radio' name='type_persalinan3' value='Forcep' <?php if ($type_persalinan3=="Forcep"){echo "checked";}?>>
										Forcep
										<input type='radio' name='type_persalinan4' value='Sectio Caesarea' <?php if ($type_persalinan4=="Sectio Caesarea"){echo "checked";}?>>
										Sectio Caesarea
										<input type='radio' name='type_persalinan5' value='Vacum' <?php if ($type_persalinan5=="Vacum"){echo "checked";}?>>
										Vacum
									</td>
								</tr>
								<tr>
									<td>BB lahir </td>
									<td coslpan='2'>
										<input type='text' name='asanak61' value='<?php echo $asanak61;?>'>gram
										Panjang Badan : <input type='text' name='asanak62' value='<?php echo $asanak62;?>'>
										cm    
								...
								<tr>
									...
									<td coslpan='2'>
										<input type='text' name='asanak64' value='<?php echo $asanak64;?>'>gram
										Tinggi Badan: <input type='text' name='asanak65' value='<?php echo $asanak65;?>'>
										cm    
									</td>
								</tr>
								<tr>
									...
									<td coslpan='2'>
										<input type='radio' name='asanak66' value='Lengkap' <?php if ($asanak66=="Lengkap"){echo "checked";}?>>
										Lengkap  
										<input type='radio' name='asanak66' value='Tidak Pernah' <?php if ($asanak66=="Tidak Pernah"){echo "checked";}?>>
										Tidak Pernah
										<input type='radio' name='asanak66' value='Tidak Lengkap' <?php if ($asanak66=="Tidak Lengkap"){echo "checked";}?>>
								...
								<?php if ($umur <= 3) {?>
									<tr>
										...
										<td coslpan='2'>											
											<input type='checkbox' name='r_tumbuhkembang1' value='Tengkurap' <?php if ($r_tumbuhkembang1=="Tengkurap"){echo "checked";}?>>Tengkurap, 
											usia :<input type='text' name='r_tumbuhkembang2' value='<?php echo $r_tumbuhkembang2;?>'><br>

											<input type='checkbox' name='r_tumbuhkembang3' value='Berjalan' <?php if ($r_tumbuhkembang3=="Berjalan"){echo "checked";}?>>Berjalan, 
											usia &nbsp;&nbsp;&nbsp;&nbsp;:<input type='text' name='r_tumbuhkembang4' value='<?php echo $r_tumbuhkembang4;?>'><br>

											<input type='checkbox' name='r_tumbuhkembang5' value='Duduk' <?php if ($r_tumbuhkembang5=="Duduk"){echo "checked";}?>>Duduk, 
											usia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type='text' name='r_tumbuhkembang6' value='<?php echo $r_tumbuhkembang6;?>'><br>

											<input type='checkbox' name='r_tumbuhkembang7' value='Bicara' <?php if ($r_tumbuhkembang7=="Bicara"){echo "checked";}?>>Bicara, 
											usia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type='text' name='r_tumbuhkembang8' value='<?php echo $r_tumbuhkembang8;?>'><br>

											<input type='checkbox' name='r_tumbuhkembang9' value='Berdiri' <?php if ($r_tumbuhkembang9=="Berdiri"){echo "checked";}?>>Berdiri, 
											usia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type='text' name='r_tumbuhkembang10' value='<?php echo $r_tumbuhkembang10;?>'><br>

											<input type='checkbox' name='r_tumbuhkembang11' value='Tumbuh gigi' <?php if ($r_tumbuhkembang11=="Tumbuh gigi"){echo "checked";}?>>Tumbuh gigi, 
											usia :<input type='text' name='r_tumbuhkembang12' value='<?php echo $r_tumbuhkembang12;?>'><br>
					...
					<tr>
						<td>
							...
							<input type='checkbox' name='nutrisi1' value='Tidak ada keluhan' <?php if ($nutrisi1=="Tidak ada keluhan"){echo "checked";}?>>Tidak ada keluhan
							<input type='checkbox' name='nutrisi2' value='Nafsu makan menurun' <?php if ($nutrisi2=="Nafsu makan menurun"){echo "checked";}?>>Nafsu makan menurun
							<input type='checkbox' name='nutrisi3' value='Mual' <?php if ($nutrisi3=="Mual"){echo "checked";}?>>Mual
							<input type='checkbox' name='nutrisi4' value='Muntah' <?php if ($nutrisi4=="Muntah"){echo "checked";}?>>Muntah
							<input type='checkbox' name='nutrisi5' value='Diet' <?php if ($nutrisi5=="Diet"){echo "checked";}?>>Diet
							Lainnya <input type='text' name='nutrisi6' value='<?php echo $nutrisi6;?>'>
							<br>
							...
							<table class="mst-table">
								...
								<tr>
									...
									<td style="border: 1px solid;"><input type='radio' name='asanak85' value='YA' <?php if ($asanak85=="YA"){echo "checked";}?>>Ya</td>
								...
								<tr>
									<td style="border: 1px solid;"><input type='radio' name='asanak86' value='Tidak' <?php if ($asanak86=="Tidak"){echo "checked";}?>>Tidak</td>
								...
								<tr>
									...
									<td style="border: 1px solid;"><input type='radio' name='asanak87' value='YA' <?php if ($asanak87=="YA"){echo "checked";}?>>Ya</td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak87){
								...
								<tr>
									<td style="border: 1px solid;"><input type='radio' name='asanak88' value='Tidak' <?php if ($asanak88=="Tidak"){echo "checked";}?>>Tidak</td>
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak88){
								...
								<tr>
									...
									<td style="border: 1px solid;"><input type='radio' name='asanak89' value='YA' <?php if ($asanak89=="YA"){echo "checked";}?>>Ya</td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak89){
								...
								<tr>
									<td style="border: 1px solid;"><input type='radio' name='asanak90' value='Tidak' <?php if ($asanak90=="Tidak"){echo "checked";}?>>Tidak</td>
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak90){
								...
								<tr>
									...
									<td style="border: 1px solid;"><input type='radio' name='asanak91' value='YA' <?php if ($asanak91=="YA"){echo "checked";}?>>Ya</td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak91){
								...
								<tr>
									<td style="border: 1px solid;"><input type='radio' name='asanak92' value='Tidak' <?php if ($asanak92=="Tidak"){echo "checked";}?>>Tidak</td>
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak92){
					...
					<tr>
						...
						<td>
							<!-- <input type='checkbox' name='asanak206' value='Gangguan eliminasi urin' <?php if ($asanak206=="Gangguan eliminasi urin"){echo "checked";}?>> Gangguan eliminasi urin<br> -->
							...
							<td>
								...
								<table class="mst-table">
									...
									<tr>
										...
										<td style="border: 1px solid;">0</td>
										<td style="border: 1px solid;"><input type='radio' name='asanak106' value='Tak Terkendali/Tak Teratur (Perlu Pencahar)' <?php if ($asanak106=="Tak Terkendali/Tak Teratur (Perlu Pencahar)"){echo "checked";}?>>
									...
									<tr>
										...
										<td style="border: 1px solid;"></td>
										<td style="border: 1px solid;">1</td>
										<td style="border: 1px solid;"><input type='radio' name='asanak107' value='Kadang-Kadang Tak Terkendali (1 X Seminggu)' <?php if ($asanak107=="Kadang-Kadang Tak Terkendali (1 X Seminggu)"){echo "checked";}?>>
									...
									<tr>
										...
										<td style="border: 1px solid;"><input type='radio' name='asanak108' value='Terkendali/Teratur' <?php if ($asanak108=="Terkendali/Teratur"){echo "checked";}?>>
									...
									<tr>
										...
										<td style="border: 1px solid;">0</td>
										<td style="border: 1px solid;"><input type='radio' name='asanak109' value='Tak Terkendali Atau Pakai Kateter' <?php if ($asanak109=="Tak Terkendali Atau Pakai Kateter"){echo "checked";}?>>
									...
									<tr>
										...
										<td style="border: 1px solid;"></td>
										<td style="border: 1px solid;">1</td>
										<td style="border: 1px solid;"><input type='radio' name='asanak110' value='Kadang-Kadang Tak Terkendali (Hanya 1 X 24 Jam)' <?php if ($asanak110=="Kadang-Kadang Tak Terkendali (Hanya 1 X 24 Jam)"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak111' value='YA' <?php if ($asanak111=="YA"){echo "checked";}?>>
									Terkendali/Teratur</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak111){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak112' value='YA' <?php if ($asanak112=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak113' value='YA' <?php if ($asanak113=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak113){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak114' value='YA' <?php if ($asanak114=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak115' value='YA' <?php if ($asanak115=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak116' value='YA' <?php if ($asanak116=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak116){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak117' value='YA' <?php if ($asanak117=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak117){
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak118' value='YA' <?php if ($asanak118=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak119' value='YA' <?php if ($asanak119=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak119){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak120' value='YA' <?php if ($asanak120=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak120){
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak121' value='YA' <?php if ($asanak121=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak122' value='YA' <?php if ($asanak122=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">3</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak123' value='YA' <?php if ($asanak123=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak123){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak124' value='YA' <?php if ($asanak124=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak124){
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak125' value='YA' <?php if ($asanak125=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak126' value='YA' <?php if ($asanak126=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">3</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak127' value='YA' <?php if ($asanak127=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak127){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak128' value='YA' <?php if ($asanak128=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak129' value='YA' <?php if ($asanak129=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak130' value='YA' <?php if ($asanak130=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak130){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak131' value='YA' <?php if ($asanak131=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak131){
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak132' value='YA' <?php if ($asanak132=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">2</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak133' value='YA' <?php if ($asanak133=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak133){
								...
								<tr>
									...
									<td style="border: 1px solid;">0</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak134' value='YA' <?php if ($asanak134=="YA"){echo "checked";}?>>
									Tergantung Orang Lain</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak134){
								...
								<tr>
									...
									<td style="border: 1px solid;"></td>
									<td style="border: 1px solid;">1</td>
									<td style="border: 1px solid;"><input type='radio' name='asanak135' value='YA' <?php if ($asanak135=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td style="border: 1px solid;">
										<?php 
										if($asanak135){
				...
				<tr>
					<td>
						E. NYERI<br>
						Keluhan nyeri : 
						<input type='radio' name='asanak136' value='Tidak' <?php if ($asanak136=="Tidak"){echo "checked";}?>>Tidak
						<input type='radio' name='asanak136' value='Ya' <?php if ($asanak136=="Ya"){echo "checked";}?>>Ya, 
						...
						<input type='radio' name='asanak139' value='Tidak' <?php if ($asanak139=="Tidak"){echo "checked";}?>>Tidak  
						<input type='radio' name='asanak139' value='Ya' <?php if ($asanak139=="Ya"){echo "checked";}?>>Ya<br>
						2. Berapa lama Nyeri ?  
						<input type='radio' name='asanak140' value='Akut : < 3 bulan' <?php if ($asanak140=="Akut : < 3 bulan"){echo "checked";}?>>Akut : < 3 bulan   
						<input type='radio' name='asanak140' value='Kronik : > 3 bulan' <?php if ($asanak140=="Kronik : > 3 bulan"){echo "checked";}?>>Kronik : > 3 bulan<br>
						3. Gambaran rasa nyeri :
						<input type='radio' name='asanak141' value='Nyeri tumpul' <?php if ($asanak141=="Nyeri tumpul"){echo "checked";}?>>  Nyeri tumpul
						<input type='radio' name='asanak141' value='Seperti ditarik' <?php if ($asanak141=="Seperti ditarik"){echo "checked";}?>>Seperti ditarik  
						<input type='radio' name='asanak141' value='Seperti ditusuk' <?php if ($asanak141=="Seperti ditusuk"){echo "checked";}?>>Seperti ditusuk
						<input type='radio' name='asanak141' value='Seperti dipukul' <?php if ($asanak141=="Seperti dipukul"){echo "checked";}?>>Seperti dipukul  
						<input type='radio' name='asanak141' value='Seperti dibakar' <?php if ($asanak141=="Seperti dibakar"){echo "checked";}?>>Seperti dibakar 
						<input type='radio' name='asanak141' value='Seperti berdenyut' <?php if ($asanak141=="Seperti berdenyut"){echo "checked";}?>>Seperti berdenyut 
						<input type='radio' name='asanak141' value='Seperti ditikam' <?php if ($asanak141=="Seperti ditikam"){echo "checked";}?>>Seperti ditikam 
						<input type='radio' name='asanak141' value='Seperti kram' <?php if ($asanak141=="Seperti kram"){echo "checked";}?>>Seperti kram <br>
						4. Seberapa sering anda mengalami nyeri ? 
						<input type='radio' name='asanak142' value='1―2 jam' <?php if ($asanak142=="1―2 jam"){echo "checked";}?>>1―2 jam  
						<input type='radio' name='asanak142' value='3―4 jam' <?php if ($asanak142=="3―4 jam"){echo "checked";}?>>3―4 jam  
						<input type='radio' name='asanak142' value='>4 jam' <?php if ($asanak142==">4 jam"){echo "checked";}?>>>4 jam 
						setiap  : 
						<input type='radio' name='asanak142' value='< 30 menit' <?php if ($asanak142=="< 30 menit"){echo "checked";}?>>< 30 menit 
						<input type='radio' name='asanak142' value='> 30 menit' <?php if ($asanak142=="> 30 menit"){echo "checked";}?>>> 30 menit <br>
						5. Apa yang membuat nyeri berkurang atau bertambah parah ? 
						<input type='radio' name='asanak143' value='Kompres hangat / dingin' <?php if ($asanak143=="Kompres hangat / dingin"){echo "checked";}?>>Kompres hangat / dingin 
						<input type='radio' name='asanak143' value='Istirahat' <?php if ($asanak143=="Istirahat"){echo "checked";}?>>Istirahat 
						<input type='radio' name='asanak143' value='Minum Obat' <?php if ($asanak143=="Minum Obat"){echo "checked";}?>>Minum Obat 
						<input type='radio' name='asanak143' value='Berubah posisi' <?php if ($asanak143=="Berubah posisi"){echo "checked";}?>>Berubah posisi<br>
						...
						<table class="mst-table">
							...
							<tr>
								...
								<td style="border: 1px solid;"><input type='radio' name='asanak144' value='Tak ada ekspresi' <?php if ($asanak144=="Tak ada ekspresi"){echo "checked";}?>>Tak ada ekspresi</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak144' value='Menyeringai' <?php if ($asanak144=="Menyeringai"){echo "checked";}?>>Menyeringai</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak144' value='Dagu gemetar & rahang dikatup erat' <?php if ($asanak144=="Dagu gemetar & rahang dikatup erat"){echo "checked";}?>>Dagu gemetar & rahang dikatup erat</td>
								<td style="border: 1px solid;">
									<?php 
							...
							<tr>
								...
								<td style="border: 1px solid;"><input type='radio' name='asanak145' value='Normal' <?php if ($asanak145=="Normal"){echo "checked";}?>>Normal</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak145' value='Gelisah tenang' <?php if ($asanak145=="Gelisah tenang"){echo "checked";}?>>Gelisah tenang</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak145' value='Menendang/ melawan' <?php if ($asanak145=="Menendang/ melawan"){echo "checked";}?>>Menendang/ melawan</td>
								<td style="border: 1px solid;">
									<?php 
									if($asanak145=='Normal')
										{$ku_tnyeri2_skor=0;}
							...
							<tr>
								...
								<td style="border: 1px solid;"><input type='radio' name='asanak146' value='Tidur tenang' <?php if ($asanak146=="Tidur tenang"){echo "checked";}?>>Tidur tenang</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak146' value='Menggeliat tenang' <?php if ($asanak146=="Menggeliat tenang"){echo "checked";}?>>Menggeliat tenang</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak146' value='Menekuk, kaku' <?php if ($asanak146=="Menekuk, kaku"){echo "checked";}?>>Menekuk, kaku</td>
								<td style="border: 1px solid;">
									<?php 
							...
							<tr>
								...
								<td style="border: 1px solid;"><input type='radio' name='asanak147' value='Tidur , tak ada tangisan' <?php if ($asanak147=="Tidur , tak ada tangisan"){echo "checked";}?>>Tidur , tak ada tangisan</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak147' value='Mengerang, merengek' <?php if ($asanak147=="Mengerang, merengek"){echo "checked";}?>>Mengerang, merengek</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak147' value='Menangis, menjerit' <?php if ($asanak147=="Menangis, menjerit"){echo "checked";}?>>Menangis, menjerit</td>
								<td style="border: 1px solid;">
									<?php 
							...
							<tr>
								...
								<td style="border: 1px solid;"><input type='radio' name='asanak148' value='Santai, nyaman' <?php if ($asanak148=="Santai, nyaman"){echo "checked";}?>>Santai, nyaman</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak148' value='Dipastikan dengan sentuhan' <?php if ($asanak148=="Dipastikan dengan sentuhan"){echo "checked";}?>>Dipastikan dengan sentuhan</td>
								<td style="border: 1px solid;"><input type='radio' name='asanak148' value='Sulit konsul / tidak nyaman' <?php if ($asanak148=="Sulit konsul / tidak nyaman"){echo "checked";}?>>Sulit konsul / tidak nyaman</td>
								<td style="border: 1px solid;">
									<?php 
...
<tr>
	...
	<td>
		<!-- <input type='checkbox' name='asanak196' value='asanak198' <?php if ($asanak198=="Hambatan Komunikasi Verbal"){echo "checked";}?>>Hambatan Komunikasi Verbal<br> -->
	</td>
</tr>
		...
		<table border='0' width="100%">
			...
			<tr>
				<td align="center">
					...
					<?php 
					QRcode::png($verif_perawat, "asan1.png", "L", 2, 2);   
					echo "<center><img src='asan1.png'></center>";
					?>
				...
				<td align="center">
					...
					if($tgl_verif){
						QRcode::png($verif_dpjp, "asan2.png", "L", 2, 2);   
						echo "<center><img src='asan2.png'></center>";
					}
					echo $dpjp;
					?>										
				</td>
