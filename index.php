...
// WHERE        (NOREG = '$noreg') and REGTUJUAN like 'R%'
...
echo '&nbsp;&nbsp;&nbsp;Unit : '.$namaunit = $dhqun['namaunit'];
	...
	<div class="row">
		...
		//cek assesment awal dokter
			...
			if(empty($am1)){
				...
				<li><a class='dropdown-item' href='r_transfer_pasien_igd.php?id=$id|$user'>Pemeriksaan dari IGD</a></li>
				</ul>
				</div>
				</div>
				<hr>
				...
				if(empty($resume20)){
					...
					<a href='soap_dokter.php?id=$id|$user' target='_blank' class='btn btn-info'><i class='bi bi-arrow-right-circle'></i> 3. CPPT</a>
					<a href='http://192.168.10.194:3010/full_screen/eresepRI/rawat_jalan/$KODEUNIT/$noreg/$norm/$user2' class='btn btn-success' target='_blank' ><i class='bi bi-arrow-right-circle'></i> 4. Penunjang : EResep - ELaborat - ERadiologi</a>
					</div>
					</div>
					";
					...
					<a href='resume_dokter.php?id=$id|$user' class='btn btn-info'><i class='bi bi-arrow-right-circle'></i> 5. Resume Medis</a>
					<a href='jadwaloperasi.php?id=$id|$user' class='btn btn-info'><i class='bi bi-arrow-right-circle'></i> 6. Laporan Operasi</a><br>
					</div>
					</div>
					</div>
					<hr>
					...
					<div class='info-box-content'>
					&nbsp;&nbsp;&nbsp;
					<a href='http://192.168.10.194:3010/full_screen/eresepRI/rawat_jalan/$KODEUNIT/$noreg/$norm/$user2' class='btn btn-success' target='_blank' ><i class='bi bi-arrow-right-circle'></i> Penunjang : EResep - ELaborat - ERadiologi</a>
					</div>
					</div>
					<hr>
					<div class='col-sm-12'>
					...
					&nbsp;&nbsp;&nbsp;
					<a href='surat_sakit.php?id=$id|$user' class='btn btn-warning'><i class='bi bi-arrow-right-circle'></i> Surat Sakit</a>
					</div>
					</div>
					";
				...
				<div class="btn-group">
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a class="dropdown-item" href="r_transfer_pasien_igd.php?id=<?php echo $id.'|'.$user;?>">Pemeriksaan dari IGD</a></li>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a class="dropdown-item" href="soap.php?id=<?php echo $id.'|'.$user;?>">CPPT</a></li>
			...
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">
						...
						<a href="transfer_pasien.php?id=<?php echo $id.'|'.$user;?>">Form Transfer Antar Unit Pelayanan</a><br>											
						<a href="raber.php?id=<?php echo $id.'|'.$user;?>">Daftar DPJP Pasien</a><br>											
				...
				<div class="col-sm-6">
					<div class="info-box">
						<div class="info-box-content">
							...
							<span class="info-box-number">
								<a href="http://192.168.10.194:3010/full_screen/eresepRI/rawat_jalan/<?php echo $KODEUNIT.'/'.$noreg.'/'.$norm.'/'.$kodedokter;?>" class='btn btn-success' target='_blank' ><i class='bi bi-arrow-right-circle'></i> Penunjang : EResep - ELaborat - ERadiologi</a>
							</span>
						</div>
					</div>
					...
					<div class="info-box">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number">
								...
								<a href="resume_print.php?id=<?php echo $id.'|'.$user;?>" target="_blank"><i>print</i></a><br> 
					...
					<div class="info-box">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number">
								...
								<a href="laborat.php?id=<?php echo $id.'|'.$user;?>"><i>Hasil Laborat</i></a> <br> 								
								<br> 									
								<a href="radiologi.php?id=<?php echo $id.'|'.$user;?>"><i>Hasil Radiologi</i></a> <br> 
							</span>
						</div>
					</div>
