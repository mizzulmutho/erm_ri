	...
	<body onload="document.myForm.td_sistolik.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						<i class="bi bi-window-plus"> &nbsp; <b>ASESMEN AWAL KEPERAWATAN DEWASA</b></i>
					</div>
				</div>
				<div class="col-12">
					<table  class="table table-bordered">
						<tr>
							<td colspan='2'><b>DIISI OLEH PERAWAT</b></td>
						</tr>
						<tr>
							<td width="70%">
						...
						<tr>
							<td width="70%">
								...
								Sumber Data : <br>
								<input type='checkbox' name='sumber_data_sendiri' value='YA' <?php if ($sumber_data_sendiri=="YA"){echo "checked";}?> >Pasien Sendiri<br>
								<input type='checkbox' name='sumber_data_keluarga' value='YA' <?php if ($sumber_data_keluarga=="YA"){echo "checked";}?> >Keluarga, 
								&nbsp;&nbsp;&nbsp;
								Nama : <input type='text' name='sumber_data_keluarga_nama' value='<?php echo $sumber_data_keluarga_nama;?>'>
								Hubungan : <input type='text' name='sumber_data_keluarga_hub' value='<?php echo $sumber_data_keluarga_hub;?>'> <br>
								<input type='checkbox' name='sumber_data_orang_lain' value='YA' <?php if ($sumber_data_orang_lain=="YA"){echo "checked";}?> >Orang Lain, 
								Nama :  <input type='text' name='sumber_data_orang_lain_nama' value='<?php echo $sumber_data_orang_lain_nama;?>'>
								Hubungan : <input type='text' name='sumber_data_orang_lain_hub' value='<?php echo $sumber_data_orang_lain_hub;?>'><br>
								Perlu interpreter bahasa :  
								...
								<input type='checkbox' name='asal_masuk' value='Instalasi Rawat Jalan(Rajal)' <?php if ($asal_masuk=="Instalasi Rawat Jalan(Rajal)"){echo "checked";}?>>Instalasi Rawat Jalan(Rajal)<br>
								Masuk Ke RS :
								...
								Diantar keluarga<br>      
								Rujukan dari <input type='text' name='rujukan_dari' value='<?php echo $rujukan_dari;?>'>
								<br>
								<input type='submit' name='simpan' value='simpan'>								
							</td>
							<td>
								AlatBantu : &nbsp;&nbsp;&nbsp;<input type='text' name='alatbantu' value='<?php echo $alatbantu;?>'><br>
								Prothesis : &nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='prothesis' value='<?php echo $Prothesis;?>'><br>
								CacatTubuh : <input type='text' name='cacat_tubuh' value='<?php echo $cacat_tubuh;?>'><br>
							</td>
						</tr>	
						<tr>
						...
						<tr>
							<td colspan='2'>
								Keluhan pasien (alasan masuk rumah sakit)  :<br>
								Riwayat penyakit sekarang : <input type='text' name='riwayat_penyakit_sekarang' value='<?php echo $riwayat_penyakit_sekarang;?>'><br>
								Riwayat penyakit dahulu : <input type='text' name='riwayat_penyakit_dahulu' value='<?php echo $riwayat_penyakit_dahulu;?>'><br>
								Riwayat penyakit keluarga : <input type='text' name='riwayat_penyakit_keluarga' value='<?php echo $riwayat_penyakit_keluarga;?>'><br>
								Obat yang sedang dikonsumsi : 
								<input type='checkbox' name='obat_sedang_dikonsumsi' value='Tidak ada' <?php if ($obat_sedang_dikonsumsi=="Tidak ada"){echo "checked";}?>>Tidak ada, 
								<input type='checkbox' name='obat_sedang_dikonsumsi' value='Ada' <?php if ($obat_sedang_dikonsumsi=="Ada"){echo "checked";}?>>Ada, tulis di form, Rekonsiliasi Obat<br>
								Riwayat alergi  :    
								<input type='checkbox' name='riwayat_alergi' value='Tidak' <?php if ($riwayat_alergi=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='riwayat_alergi' value='Ya' <?php if ($riwayat_alergi=="Ya"){echo "checked";}?>>Ya, 
								Keterangan Alergi : <input type='text' name='riwayat_alergi_alergi' value='<?php echo $riwayat_alergi_alergi;?>'><br>
								Makanan<br>
								Reaksi :<br>
								Riwayat transfusi darah  : 
								<input type='checkbox' name='riwayat_tranfusi_darah' value='Tidak' <?php if ($riwayat_tranfusi_darah=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='riwayat_tranfusi_darah' value='Ya' <?php if ($riwayat_tranfusi_darah=="Ya"){echo "checked";}?>>Ya, 
								reaksi alergi : 
								<input type='checkbox' name='reaksi_alergi' value='Tidak' <?php if ($reaksi_alergi=="Tidak"){echo "checked";}?>>Tidak 
								<input type='checkbox' name='reaksi_alergi' value='Ya' <?php if ($reaksi_alergi=="Ya"){echo "checked";}?>>Ya 
								<input type='text' name='ket_reaksi_alergi' value='<?php echo $ket_reaksi_alergi;?>'><br>
								Riwayat merokok : <input type='text' name='riwayat_merokok' value='<?php echo $riwayat_merokok;?>'><br>
								Riwayat minum minuman keras : <input type='text' name='riwayat_minuman_keras' value='<?php echo $riwayat_minuman_keras;?>'><br>
								Riwayat pergi keluar negeri : <input type='text' name='riwayat_keluar_negri' value='<?php echo $riwayat_keluar_negri;?>'><br>
								<br>
								<input type='submit' name='simpan' value='simpan'>			
							</td>
						</tr>
						...
						<tr>
							<td>
								A. KEADAAN UMUM<br>
								Kesadaran  : 
								<input type='checkbox' name='ku_kesadaran' value='Composmentis' <?php if ($ku_kesadaran=="Composmentis"){echo "checked";}?>>Composmentis 
								...
								<input type='checkbox' name='ku_kesadaran' value='Coma' <?php if ($ku_kesadaran=="Coma"){echo "checked";}?>>Coma<br>
								GCS : 
								E : <input type='text' name='ku_gcs_e' value='<?php echo $ku_gcs_e;?>'>
								V : <input type='text' name='ku_gcs_v' value='<?php echo $ku_gcs_v;?>'>
								M : <input type='text' name='ku_gcs_m' value='<?php echo $ku_gcs_m;?>'><br>
								Suhu : <input type='text' name='ku_suhu' value='<?php echo $ku_suhu;?>'> C    
								Tekanan Darah : <input type='text' name='ku_tensi' value='<?php echo $ku_tensi;?>'> /mmHg<br>
								Nadi : <input type='text' name='ku_nadi' value='<?php echo $ku_nadi;?>'> x/mnt     
								<input type='checkbox' name='ku_nadi_ket' value='Teratur' <?php if ($ku_kesadaran=="Teratur"){echo "checked";}?>>Teratur    
								<input type='checkbox' name='ku_nadi_ket' value='Tidak Teratur' <?php if ($ku_kesadaran=="Tidak Teratur"){echo "checked";}?>>Tidak Teratur<br>
								Nafas  : <input type='text' name='ku_nafas' value='<?php echo $ku_nafas;?>'> x/mnt<br>      
								SpO2  : <input type='text' name='ku_spo' value='<?php echo $ku_spo;?>'> %<br> 
								<br>
								<input type='submit' name='simpan' value='simpan'>	
								<hr>     
								B. RESPIRASI<br>
								Pergerakan dada : 
								<input type='checkbox' name='ku_respirasi_dada' value='Asimetris' <?php if ($ku_respirasi_dada=="Asimetris"){echo "checked";}?>>Asimetris  
								<input type='checkbox' name='ku_respirasi_dada' value='Simetris' <?php if ($ku_respirasi_dada=="Simetris"){echo "checked";}?>>Simetris<br>
								Pola nafas  : 
								<input type='checkbox' name='ku_respirasi_nafas' value='Irama' <?php if ($ku_respirasi_nafas=="Irama"){echo "checked";}?>>Irama    
								<input type='checkbox' name='ku_respirasi_nafas' value='Teratur' <?php if ($ku_respirasi_nafas=="Teratur"){echo "checked";}?>>Teratur 
								<input type='checkbox' name='ku_respirasi_nafas' value='Tidak Teratur' <?php if ($ku_respirasi_nafas=="Tidak Teratur"){echo "checked";}?>>Tidak Teratur
								<input type='checkbox' name='ku_respirasi_nafas' value='Jenis' <?php if ($ku_respirasi_nafas=="Jenis"){echo "checked";}?>>Jenis     
								<input type='checkbox' name='ku_respirasi_nafas' value='Biot' <?php if ($ku_respirasi_nafas=="Biot"){echo "checked";}?>>Biot  
								<input type='checkbox' name='ku_respirasi_nafas' value='Cheyne Stokes' <?php if ($ku_respirasi_nafas=="Cheyne Stokes"){echo "checked";}?>>Cheyne Stokes <input type='checkbox' name='ku_respirasi_nafas' value='Khusmaul' <?php if ($ku_respirasi_nafas=="Khusmaul"){echo "checked";}?>>Khusmaul<br>
								Suara nafas : 
								<input type='checkbox' name='ku_suara_nafas' value='Vesikuler' <?php if ($ku_suara_nafas=="Vesikuler"){echo "checked";}?>>Vesikuler  
								<input type='checkbox' name='ku_suara_nafas' value='Ronchi' <?php if ($ku_suara_nafas=="Ronchi"){echo "checked";}?>>Ronchi
								<input type='checkbox' name='ku_suara_nafas' value='Wheezing' <?php if ($ku_suara_nafas=="Wheezing"){echo "checked";}?>>Wheezing<br>
								Sesak nafas  :
								<input type='checkbox' name='ku_sesak_nafas' value='Tidak ada' <?php if ($ku_sesak_nafas=="Tidak ada"){echo "checked";}?>>Tidak ada
								<input type='checkbox' name='ku_sesak_nafas' value='Ya, Pada saat' <?php if ($ku_sesak_nafas=="Ya, Pada saat"){echo "checked";}?>>Ya, Pada saat :    <input type='checkbox' name='ku_sesak_nafas_ada' value='Inspirasi' <?php if ($ku_sesak_nafas_ada=="Inspirasi"){echo "checked";}?>>Inspirasi
								...
								<input type='checkbox' name='ku_sesak_nafas_ada' value='Aktifitas' <?php if ($ku_sesak_nafas_ada=="Aktifitas"){echo "checked";}?>>Aktifitas<br>
								Otot bantu nafas :
								<input type='checkbox' name='ku_otot_bantu_nafas' value='Tidak' <?php if ($ku_otot_bantu_nafas=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='ku_otot_bantu_nafas' value='Ya' <?php if ($ku_otot_bantu_nafas=="Ya"){echo "checked";}?>>Ya<br>
								Batuk : 
								<input type='checkbox' name='ku_batuk' value='Tidak' <?php if ($ku_batuk=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='ku_batuk' value='Ya' <?php if ($ku_batuk=="Ya"){echo "checked";}?>>Ya,
								Produksi sputum : 
								<input type='checkbox' name='ku_sputum' value='Tidak' <?php if ($ku_sputum=="Tidak"){echo "checked";}?>>Tidak  
								<input type='checkbox' name='ku_sputum' value='Ya' <?php if ($ku_sputum=="Ya"){echo "checked";}?>>Ya, 
								Warna : <input type='text' name='ku_batuk_warna' value='<?php echo $ku_batuk_warna;?>'>
								<br>
								Penggunaan alat medis : 
								<input type='checkbox' name='ku_alat_medis' value='Tidak' <?php if ($ku_alat_medis=="Tidak"){echo "checked";}?>>Tidak 
								<input type='checkbox' name='ku_alat_medis' value='Ya' <?php if ($ku_alat_medis=="Ya"){echo "checked";}?>>Ya, 
								sebutkan : <input type='text' name='ku_alat_medis_ket' value='<?php echo $ku_alat_medis_ket;?>'><br>
								<input type='submit' name='simpan' value='simpan'>
								<hr>
								C. IRKULASI<br>
								Irama Jantung : 
								<input type='checkbox' name='ku_irkulasi_jantung' value='Reguler' <?php if ($ku_irkulasi_jantung=="Reguler"){echo "checked";}?>>Reguler 
								<input type='checkbox' name='ku_irkulasi_jantung' value='Ireguler' <?php if ($ku_irkulasi_jantung=="Ireguler"){echo "checked";}?>>Ireguler<br>
								Suara Jantung : 
								<input type='checkbox' name='ku_suara_jantung' value='Tidak ada kelainan' <?php if ($ku_suara_jantung=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada <input type='checkbox' name='ku_suara_jantung' value='kelainan' <?php if ($ku_suara_jantung=="kelainan"){echo "checked";}?>>kelainan<br>    
								Akral : <input type='text' name='ku_kelainan_jantung_akral' value='<?php echo $ku_kelainan_jantung_akral;?>'>
								CRT: <input type='text' name='ku_kelainan_jantung_crt' value='<?php echo $ku_kelainan_jantung_crt;?>'><br>
								Anemis :
								<input type='checkbox' name='ku_irkulasi_anemis' value='Tidak' <?php if ($ku_irkulasi_anemis=="Tidak"){echo "checked";}?>>Tidak 
								<input type='checkbox' name='ku_irkulasi_anemis' value='Ya' <?php if ($ku_irkulasi_anemis=="Ya"){echo "checked";}?>>Ya, 
								Hb : <input type='text' name='ku_irkulasi_anemis_hb' value='<?php echo $ku_irkulasi_anemis_hb;?>'>mg/dl<br>
								Distensi vena jugular  : 
								<input type='checkbox' name='ku_irkulasi_vena' value='Tidak' <?php if ($ku_irkulasi_vena=="Tidak"){echo "checked";}?>> Tidak
								<input type='checkbox' name='ku_irkulasi_vena' value='Ya' <?php if ($ku_irkulasi_vena=="Tidak"){echo "checked";}?>> Ya<br>
								Penggunaan alat medis: 
								<input type='checkbox' name='ku_irkulasi_alat_medis' value='Tidak' <?php if ($ku_irkulasi_alat_medis=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='ku_irkulasi_alat_medis' value='Ya' <?php if ($ku_irkulasi_alat_medis=="Ya"){echo "checked";}?>>Ya, 
								sebutkan : <input type='text' name='ku_irkulasi_alat_medis_ket' value='<?php echo $ku_irkulasi_alat_medis_ket;?>'><br>
								<input type='submit' name='simpan' value='simpan'>
								<hr>
								D. PERSEPSI DAN SENSORI<br>
								Reflek fisiologis : 
								<input type='checkbox' name='ku_persepsi_fisiologis' value='Patela' <?php if ($ku_persepsi_fisiologis=="Patela"){echo "checked";}?>>Patela
								<input type='checkbox' name='ku_persepsi_fisiologis' value='Triceps' <?php if ($ku_persepsi_fisiologis=="Triceps"){echo "checked";}?>>Triceps
								<input type='checkbox' name='ku_persepsi_fisiologis' value='Biseps' <?php if ($ku_persepsi_fisiologis=="Biseps"){echo "checked";}?>>Biseps<br>
								Reflek Patologis : 
								<input type='checkbox' name='ku_persepsi_patologis' value='Babinsky' <?php if ($ku_persepsi_patologis=="Babinsky"){echo "checked";}?>>Babinsky
								<input type='checkbox' name='ku_persepsi_patologis' value='Brudzinsky' <?php if ($ku_persepsi_patologis=="Brudzinsky"){echo "checked";}?>>Brudzinsky
								<input type='checkbox' name='ku_persepsi_patologis' value='Kerning' <?php if ($ku_persepsi_patologis=="Kerning"){echo "checked";}?>>Kerning<br>
								Mata : 
								<input type='checkbox' name='ku_persepsi_mata' value='Normal' <?php if ($ku_persepsi_mata=="Normal"){echo "checked";}?>>Normal
								<input type='checkbox' name='ku_persepsi_mata' value='Kabur' <?php if ($ku_persepsi_mata=="Kabur"){echo "checked";}?>>Kabur     
								<input type='checkbox' name='ku_persepsi_mata' value='Diplopia' <?php if ($ku_persepsi_mata=="Diplopia"){echo "checked";}?>>Diplopia    
								<input type='checkbox' name='ku_persepsi_mata' value='Buta' <?php if ($ku_persepsi_mata=="Buta"){echo "checked";}?>>Buta
								<input type='checkbox' name='ku_persepsi_mata' value='Strabismus' <?php if ($ku_persepsi_mata=="Strabismus"){echo "checked";}?>>Strabismus<br>
								Pupil : 
								<input type='checkbox' name='ku_persepsi_pupil' value='Isokor' <?php if ($ku_persepsi_pupil=="Isokor"){echo "checked";}?>>Isokor 
								<input type='checkbox' name='ku_persepsi_pupil' value='Anisokor' <?php if ($ku_persepsi_pupil=="Anisokor"){echo "checked";}?>>Anisokor
								<input type='checkbox' name='ku_persepsi_pupil' value='Reaksi Cahaya' <?php if ($ku_persepsi_pupil=="Reaksi Cahaya"){echo "checked";}?>>Reaksi Cahaya<br>
								Telinga : 
								<input type='checkbox' name='ku_persepsi_telinga' value='Normal' <?php if ($ku_persepsi_telinga=="Normal"){echo "checked";}?>>Normal
								<input type='checkbox' name='ku_persepsi_telinga' value='Berkurang' <?php if ($ku_persepsi_telinga=="Berkurang"){echo "checked";}?>>Berkurang 
								<input type='checkbox' name='ku_persepsi_telinga' value='Serumen' <?php if ($ku_persepsi_telinga=="Serumen"){echo "checked";}?>>Serumen
								<input type='checkbox' name='ku_persepsi_telinga' value='Tuli' <?php if ($ku_persepsi_telinga=="Tuli"){echo "checked";}?>>Tuli
								<input type='checkbox' name='ku_persepsi_telinga' value='Tinitus' <?php if ($ku_persepsi_telinga=="Tinitus"){echo "checked";}?>>Tinitus<br>
								Hidung :
								<input type='checkbox' name='ku_persepsi_hidung' value='Normal' <?php if ($ku_persepsi_hidung=="Normal"){echo "checked";}?>>Normal 
								<input type='checkbox' name='ku_persepsi_hidung' value='Berkurang' <?php if ($ku_persepsi_hidung=="Berkurang"){echo "checked";}?>>Berkurang
								<input type='checkbox' name='ku_persepsi_hidung' value='Epistaksis' <?php if ($ku_persepsi_hidung=="Epistaksis"){echo "checked";}?>>Epistaksis
								<input type='checkbox' name='ku_persepsi_hidung' value='Sekret' <?php if ($ku_persepsi_hidung=="Sekret"){echo "checked";}?>>Sekret 
								<input type='checkbox' name='ku_persepsi_hidung' value='Tersumbat' <?php if ($ku_persepsi_hidung=="Tersumbat"){echo "checked";}?>>Tersumbat<br>
								Sensibilitas : 
								<input type='checkbox' name='ku_persepsi_sensibilitas' value='Normal' <?php if ($ku_persepsi_sensibilitas=="Normal"){echo "checked";}?>>Normal
								<input type='checkbox' name='ku_persepsi_sensibilitas' value='Kesemutan' <?php if ($ku_persepsi_sensibilitas=="Kesemutan"){echo "checked";}?>>Kesemutan 
								<input type='checkbox' name='ku_persepsi_sensibilitas' value='Baal' <?php if ($ku_persepsi_sensibilitas=="Baal"){echo "checked";}?>>Baal     
								<input type='checkbox' name='ku_persepsi_sensibilitas' value='Hiperestesi' <?php if ($ku_persepsi_sensibilitas=="Hiperestesi"){echo "checked";}?>>Hiperestesi, 
								<input type='checkbox' name='ku_persepsi_sensibilitas' value='Lokasi' <?php if ($ku_persepsi_sensibilitas=="Lokasi"){echo "checked";}?>>Lokasi : Bicara :
								<input type='checkbox' name='ku_persepsi_bicara' value='Normal' <?php if ($ku_persepsi_bicara=="Normal"){echo "checked";}?>>Normal
								<input type='checkbox' name='ku_persepsi_bicara' value='Afasia' <?php if ($ku_persepsi_bicara=="Afasia"){echo "checked";}?>>Afasia<br>
								Kaku kuduk : 
								<input type='checkbox' name='ku_persepsi_kaku_duduk' value='Tidak' <?php if ($ku_persepsi_kaku_duduk=="Tidak"){echo "checked";}?>>Tidak  
								<input type='checkbox' name='ku_persepsi_kaku_duduk' value='Ya' <?php if ($ku_persepsi_kaku_duduk=="Ya"){echo "checked";}?>>Ya<br>
								Penggunaan alat bantu : 
								<input type='checkbox' name='ku_persepsi_alat_bantu' value='Tidak' <?php if ($ku_persepsi_alat_bantu=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='ku_persepsi_alat_bantu' value='Ya' <?php if ($ku_persepsi_alat_bantu=="Ya"){echo "checked";}?>>Ya, 
								sebutkan : <input type='text' name='ku_persepsi_alat_bantu_ket' value='<?php echo $ku_persepsi_alat_bantu_ket;?>'><br>							
								<input type='submit' name='simpan' value='simpan'>
							</td>
							<td>
								<input type='checkbox' name='ku_hipermi' value='Hipertermi' <?php if ($ku_hipermi=="Hipertermi"){echo "checked";}?>>Hipertermi<br>
								<input type='checkbox' name='ku_hipotermia' value='Hipotermia' <?php if ($ku_hipotermia=="Hipotermia"){echo "checked";}?>>Hipotermia<br>
								<input type='checkbox' name='ku_masalah1' value='Bersihan jalan napas tidak efektif' <?php if ($ku_masalah1=="Bersihan jalan napas tidak efektif"){echo "checked";}?>>Bersihan jalan napas tidak efektif<br>
								<input type='checkbox' name='ku_masalah2' value='Gangguan pertukaran gas' <?php if ($ku_masalah2=="Gangguan pertukaran gas"){echo "checked";}?>>Gangguan pertukaran gas<br>
								<input type='checkbox' name='ku_masalah3' value='Pola napas tidak efektif' <?php if ($ku_masalah3=="Pola napas tidak efektif"){echo "checked";}?>>Pola napas tidak efektif<br>
								<input type='checkbox' name='ku_masalah4' value='Resiko aspirasi' <?php if ($ku_masalah4=="Resiko aspirasi"){echo "checked";}?>>Resiko aspirasi<br>
								<input type='checkbox' name='ku_masalah5' value='Penurunan curah jantung' <?php if ($ku_masalah5=="Penurunan curah jantung"){echo "checked";}?>>Penurunan curah jantung<br>
								<input type='checkbox' name='ku_masalah6' value='Perfusi perifer tidak efektif' <?php if ($ku_masalah6=="Perfusi perifer tidak efektif"){echo "checked";}?>>Perfusi perifer tidak efektif<br>
								<input type='checkbox' name='ku_masalah7' value='Resiko perdarahan' <?php if ($ku_masalah7=="Resiko perdarahan"){echo "checked";}?>>Resiko perdarahan<br>
								<input type='checkbox' name='ku_masalah8' value='Resiko perfusi miokard tidak efektif' <?php if ($ku_masalah8=="Resiko perfusi miokard tidak efektif"){echo "checked";}?>>Resiko perfusi miokard tidak efektif<br>
								masalah lain : <input type='text' name='ku_masalah_lain' value='<?php echo $ku_masalah_lain;?>'><br>							
								<input type='submit' name='simpan' value='simpan'>
							</td>
						</tr>
						<tr>
							<td>
								Nyeri<br>
								Keluhan nyeri : 
								<input type='checkbox' name='ku_nyeri' value='Tidak' <?php if ($ku_nyeri=="Tidak"){echo "checked";}?>>Tidak
								<input type='checkbox' name='ku_nyeri' value='Ya' <?php if ($ku_nyeri=="Ya"){echo "checked";}?>>Ya, 
								Skala : <input type='text' name='ku_nyeri_skala' value='<?php echo $ku_nyeri_skala;?>'><br>
								...
								<input type='checkbox' name='ku_tanya1' value='Tidak' <?php if ($ku_tanya1=="Tidak"){echo "checked";}?>>Tidak  
								<input type='checkbox' name='ku_tanya1' value='Ya' <?php if ($ku_tanya1=="Ya"){echo "checked";}?>>Ya<br>
								2. Berapa lama Nyeri ?  
								<input type='checkbox' name='ku_tanya2' value='Akut : < 3 bulan' <?php if ($ku_tanya2=="Akut : < 3 bulan"){echo "checked";}?>>Akut : < 3 bulan   
								<input type='checkbox' name='ku_tanya2' value='Kronik : > 3 bulan' <?php if ($ku_tanya2=="Kronik : > 3 bulan"){echo "checked";}?>>Kronik : > 3 bulan<br>
								...
								<table>
									...
									<tr>
										<td>FACE  (WAJAH)</td>
										<td><input type='checkbox' name='ku_tnyeri1' value='Tak ada ekspresi' <?php if ($ku_tnyeri1=="Tak ada ekspresi"){echo "checked";}?>>Tak ada ekspresi</td>
										<td><input type='checkbox' name='ku_tnyeri1' value='Menyeringai' <?php if ($ku_tnyeri1=="Menyeringai"){echo "checked";}?>>Menyeringai</td>
										<td><input type='checkbox' name='ku_tnyeri1' value='Dagu gemetar & rahang dikatup erat' <?php if ($ku_tnyeri1=="Dagu gemetar & rahang dikatup erat"){echo "checked";}?>>Dagu gemetar & rahang dikatup erat</td>
										<td>
											<?php 
									...
									<tr>
										<td>LEG  (KAKI)</td>
										<td><input type='checkbox' name='ku_tnyeri2' value='Normal' <?php if ($ku_tnyeri2=="Normal"){echo "checked";}?>>Normal</td>
										<td><input type='checkbox' name='ku_tnyeri2' value='Gelisah tenang' <?php if ($ku_tnyeri2=="Gelisah tenang"){echo "checked";}?>>Gelisah tenang</td>
										<td><input type='checkbox' name='ku_tnyeri2' value='Menendang/ melawan' <?php if ($ku_tnyeri2=="Menendang/ melawan"){echo "checked";}?>>Menendang/ melawan</td>
										<td>
											<?php 
									...
									<tr>
										...
										<td><input type='checkbox' name='ku_tnyeri3' value='Tidur tenang' <?php if ($ku_tnyeri3=="Tidur tenang"){echo "checked";}?>>Tidur tenang</td>
										<td><input type='checkbox' name='ku_tnyeri3' value='Menggeliat tenang' <?php if ($ku_tnyeri3=="Menggeliat tenang"){echo "checked";}?>>Menggeliat tenang</td>
										<td><input type='checkbox' name='ku_tnyeri3' value='Menekuk, kaku' <?php if ($ku_tnyeri3=="Menekuk, kaku"){echo "checked";}?>>Menekuk, kaku</td>
										<td>
											<?php 
									...
									<tr>
										<td>CRY (MENANGIS)</td>
										<td><input type='checkbox' name='ku_tnyeri4' value='Tidur , tak ada tangisan' <?php if ($ku_tnyeri4=="Tidur , tak ada tangisan"){echo "checked";}?>>Tidur , tak ada tangisan</td>
										<td><input type='checkbox' name='ku_tnyeri4' value='Mengerang, merengek' <?php if ($ku_tnyeri4=="Mengerang, merengek"){echo "checked";}?>>Mengerang, merengek</td>
										<td><input type='checkbox' name='ku_tnyeri4' value='Menangis, menjerit' <?php if ($ku_tnyeri4=="Menangis, menjerit"){echo "checked";}?>>Menangis, menjerit</td>
										<td>
											<?php 
									...
									<tr>
										<td>CONSOLABILITY</td>
										<td><input type='checkbox' name='ku_tnyeri5' value='Santai, nyaman' <?php if ($ku_tnyeri5=="Santai, nyaman"){echo "checked";}?>>Santai, nyaman</td>
										<td><input type='checkbox' name='ku_tnyeri5' value='Dipastikan dengan sentuhan' <?php if ($ku_tnyeri5=="Dipastikan dengan sentuhan"){echo "checked";}?>>Dipastikan dengan sentuhan</td>
										<td><input type='checkbox' name='ku_tnyeri5' value='Sulit konsul / tidak nyaman' <?php if ($ku_tnyeri5=="Sulit konsul / tidak nyaman"){echo "checked";}?>>Sulit konsul / tidak nyaman</td>
										<td>
											<?php 
								...
								E. ELIMINASI<br>
								BAK : 
								Frekuensi <input type='text' name='ku_eliminasi1' value='<?php echo $ku_eliminasi1;?>'> x/hari  
								...
								Frekuensi  : <input type='text' name='ku_eliminasi7' value='<?php echo $ku_eliminasi7;?>'>x/hari,  
								...
								Pola minum : 
								Jumlah : <input type='text' name='ku_nutrisi5' value='<?php echo $ku_nutrisi5;?>'> cc/gelas/hari 
								...
								<table>
									...
									<tr>
										<td></td>
										<td>a. Tidak<input type='checkbox' name='ku_tnutrisi1' value='Tidak' <?php if ($ku_tnutrisi1=="Tidak"){echo "checked";}?>></td>
										<td>
											<?php 
									...
									<tr>
										<td></td>
										<td>b. Tidak yakin<input type='checkbox' name='ku_tnutrisi2' value='Tidak yakin' <?php if ($ku_tnutrisi2=="Tidak yakin"){echo "checked";}?>></td>
										<td>
											<?php 
									...
									<tr>
										<td></td>
										<td>1-5 kg<input type='checkbox' name='ku_tnutrisi3' value='1-5 kg' <?php if ($ku_tnutrisi3=="1-5 kg"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi3){
									...
									<tr>
										<td></td>
										<td>6-10 kg<input type='checkbox' name='ku_tnutrisi4' value='6-10 kg' <?php if ($ku_tnutrisi4=="6-10 kg"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi4){
									...
									<tr>
										<td></td>
										<td>11-15 kg<input type='checkbox' name='ku_tnutrisi5' value='11-15 kg' <?php if ($ku_tnutrisi5=="11-15 kg"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi5){
									...
									<tr>
										<td></td>
										<td>> 15 kg<input type='checkbox' name='ku_tnutrisi6' value='> 15 kg' <?php if ($ku_tnutrisi6=="> 15 kg"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi6){
									...
									<tr>
										<td></td>
										<td>Tidak tahu berapa kg penurunannya<input type='checkbox' name='ku_tnutrisi7' value='Tidak tahu berapa kg penurunannya' <?php if ($ku_tnutrisi7=="Tidak tahu berapa kg penurunannya"){echo "checked";}?>>
										</td>
										<td>
											<?php 
											if($ku_tnutrisi7){
									...
									<tr>
										<td></td>
										<td>a. Tidak<input type='checkbox' name='ku_tnutrisi8' value='Tidak' <?php if ($ku_tnutrisi8=="Tidak"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi8){
									...
									<tr>
										<td></td>
										<td>b. Ya<input type='checkbox' name='ku_tnutrisi9' value='Ya' <?php if ($ku_tnutrisi9=="Ya"){echo "checked";}?>></td>
										<td>
											<?php 
											if($ku_tnutrisi9){
								...
								<tr>
									<td>3</td>
									<td>Pasien dengan diagnosa khusus : (lingkari diagnosa yang sesuai pasien)<br>
									...
									<td><input type='text' name='ku_tnutrisi10' value='<?php echo $ku_tnutrisi10;?>'> </td>
								</tr>
							</table>
							<br>
							<input type='submit' name='simpan' value='simpan'><br>
						...
						<td>
							<input type='checkbox' name='ku_nyerimasalah1' value='Nyeri akut' <?php if ($ku_nyerimasalah1=="Nyeri akut"){echo "checked";}?>> Nyeri akut<br>
							<input type='checkbox' name='ku_nyerimasalah2' value='Nyeri kronis' <?php if ($ku_nyerimasalah2=="Nyeri kronis"){echo "checked";}?>> Nyeri kronis<br>
							<input type='checkbox' name='ku_nyerimasalah3' value='Gangguan eliminasi urin' <?php if ($ku_nyerimasalah3=="Gangguan eliminasi urin"){echo "checked";}?>> Gangguan eliminasi urin<br>
							<input type='checkbox' name='ku_nyerimasalah4' value='Konstipasi' <?php if ($ku_nyerimasalah4=="Konstipasi"){echo "checked";}?>> Konstipasi<br>
							<input type='checkbox' name='ku_nyerimasalah5' value='Retensi urin' <?php if ($ku_nyerimasalah5=="Retensi urin"){echo "checked";}?>> Retensi urin<br>
							<input type='checkbox' name='ku_nyerimasalah6' value='Diare' <?php if ($ku_nyerimasalah6=="Diare"){echo "checked";}?>> Diare<br>
							<input type='checkbox' name='ku_nyerimasalah7' value='Hipervolemia' <?php if ($ku_nyerimasalah7=="Hipervolemia"){echo "checked";}?>> Hipervolemia<br>
							<input type='checkbox' name='ku_nyerimasalah8' value='Hipovolemia' <?php if ($ku_nyerimasalah8=="Hipovolemia"){echo "checked";}?>> Hipovolemia<br>
							<input type='checkbox' name='ku_nyerimasalah9' value='Nausea' <?php if ($ku_nyerimasalah9=="Nausea"){echo "checked";}?>> Nausea<br>
							<input type='checkbox' name='ku_nyerimasalah10' value='Defisit Nutrisi<' <?php if ($ku_nyerimasalah10=="Defisit Nutrisi<"){echo "checked";}?>> Defisit Nutrisi<br>
								<input type='checkbox' name='ku_nyerimasalah11' value='Resiko syok' <?php if ($ku_nyerimasalah11=="Resiko syok"){echo "checked";}?>> Resiko syok<br>
								Masalah Lain : <input type='text' name='ku_nyerimasalah12' value='<?php echo $ku_nyerimasalah12;?>'><br>
								<br>
								<input type='submit' name='simpan' value='simpan'><br>
							</td>
						</tr>
						<tr>
							<td>
								...
								<input type='checkbox' name='aktivitas1' value='Tidur/istirahat' <?php if ($aktivitas1=="Tidur/istirahat"){echo "checked";}?>>Tidur/istirahat   
								<input type='checkbox' name='aktivitas1' value='Tidak ada keluhan' <?php if ($aktivitas1=="Tidak ada keluhan"){echo "checked";}?>>Tidak ada keluhan<br>   
								<table>
									<tr>
										<td>No</td>
										<td>Fungsi</td>
									...
									<tr>
										...
										<td>0</td>
										<td><input type='checkbox' name='taktivitas1' value='Tak Terkendali/Tak Teratur (Perlu Pencahar)' <?php if ($taktivitas1=="Tak Terkendali/Tak Teratur (Perlu Pencahar)"){echo "checked";}?>>
									...
									<tr>
										...
										<td></td>
										<td>1</td>
										<td><input type='checkbox' name='taktivitas2' value='Kadang-Kadang Tak Terkendali (1 X Seminggu)' <?php if ($taktivitas2=="Kadang-Kadang Tak Terkendali (1 X Seminggu)"){echo "checked";}?>>
									...
									<tr>
										...
										<td></td>
										<td>2</td>
										<td><input type='checkbox' name='taktivitas3' value='Terkendali/Teratur' <?php if ($taktivitas3=="Terkendali/Teratur"){echo "checked";}?>>
									...
									<tr>
										...
										<td>0</td>
										<td><input type='checkbox' name='taktivitas4' value='Tak Terkendali Atau Pakai Kateter' <?php if ($taktivitas4=="Tak Terkendali Atau Pakai Kateter"){echo "checked";}?>>
									...
									<tr>
										...
										<td></td>
										<td>1</td>
										<td><input type='checkbox' name='taktivitas5' value='Kadang-Kadang Tak Terkendali (Hanya 1 X 24 Jam)' <?php if ($taktivitas5=="Kadang-Kadang Tak Terkendali (Hanya 1 X 24 Jam)"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas6' value='YA' <?php if ($taktivitas6=="YA"){echo "checked";}?>>
									Terkendali/Teratur</td>
									<td>
										<?php 
										if($taktivitas6){
								...
								<tr>
									...
									<td>0</td>
									<td><input type='checkbox' name='taktivitas7' value='YA' <?php if ($taktivitas7=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas8' value='YA' <?php if ($taktivitas8=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas8){
								...
								<tr>
									...
									<td>0</td>
									<td><input type='checkbox' name='taktivitas9' value='YA' <?php if ($taktivitas9=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas10' value='YA' <?php if ($taktivitas10=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas11' value='YA' <?php if ($taktivitas11=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas11){
								...
								<tr>
									...
									<td>Makan</td>
									<td>0</td>
									<td><input type='checkbox' name='taktivitas12' value='YA' <?php if ($taktivitas12=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td>
										<?php 
										if($taktivitas12){
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas13' value='YA' <?php if ($taktivitas13=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas14' value='YA' <?php if ($taktivitas14=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas14){
								...
								<tr>
									...
									<td>Transfer</td>
									<td>0</td>
									<td><input type='checkbox' name='taktivitas15' value='YA' <?php if ($taktivitas15=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td>
										<?php 
										if($taktivitas15){
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas16' value='YA' <?php if ($taktivitas16=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas17' value='YA' <?php if ($taktivitas17=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>3</td>
									<td><input type='checkbox' name='taktivitas18' value='YA' <?php if ($taktivitas18=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas18){
								...
								<tr>
									...
									<td>Mobilitas</td>
									<td>0</td>
									<td><input type='checkbox' name='taktivitas19' value='YA' <?php if ($taktivitas19=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td>
										<?php 
										if($taktivitas19){
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas20' value='YA' <?php if ($taktivitas20=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas21' value='YA' <?php if ($taktivitas21=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>3</td>
									<td><input type='checkbox' name='taktivitas22' value='YA' <?php if ($taktivitas22=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas22){
								...
								<tr>
									...
									<td>Berpakaian</td>
									<td>0</td>
									<td><input type='checkbox' name='taktivitas23' value='YA' <?php if ($taktivitas23=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas24' value='YA' <?php if ($taktivitas24=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas25' value='YA' <?php if ($taktivitas25=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas25){
								...
								<tr>
									...
									<td>0</td>
									<td><input type='checkbox' name='taktivitas26' value='YA' <?php if ($taktivitas26=="YA"){echo "checked";}?>>
									Tidak Mampu</td>
									<td>
										<?php 
										if($taktivitas26){
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas27' value='YA' <?php if ($taktivitas27=="YA"){echo "checked";}?>>
								...
								<tr>
									...
									<td></td>
									<td>2</td>
									<td><input type='checkbox' name='taktivitas28' value='YA' <?php if ($taktivitas28=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas28){
								...
								<tr>
									...
									<td>Mandi</td>
									<td>0</td>
									<td><input type='checkbox' name='taktivitas29' value='YA' <?php if ($taktivitas29=="YA"){echo "checked";}?>>
									Tergantung Orang Lain</td>
									<td>
										<?php 
										if($taktivitas29){
								...
								<tr>
									...
									<td></td>
									<td>1</td>
									<td><input type='checkbox' name='taktivitas30' value='YA' <?php if ($taktivitas30=="YA"){echo "checked";}?>>
									Mandiri</td>
									<td>
										<?php 
										if($taktivitas30){
							...
							<input type='checkbox' name='kulit6' value='Ya' <?php if ($kulit6=="Ya"){echo "checked";}?>>Ya, 
							...
							<table>
								...
								<tr>
									<td>1</td>
									<td>Kondisi Fisik</td>
									<td><input type='checkbox' name='tkulit1' value='YA' <?php if ($tkulit1=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit2' value='YA' <?php if ($tkulit2=="YA"){echo "checked";}?>>
									Cukup</td>
									<td>3</td>
									<?php 
									if($tkulit2){
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit3' value='YA' <?php if ($tkulit3=="YA"){echo "checked";}?>>
									Buruk</td>
									<td>2</td>
									<?php 
									if($tkulit3){
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit4' value='YA' <?php if ($tkulit4=="YA"){echo "checked";}?>>
									Sangat Buruk</td>
									<td>1</td>
									<?php 
									if($tkulit4){
								...
								<tr>
									...
									<td><input type='checkbox' name='tkulit5' value='YA' <?php if ($tkulit5=="YA"){echo "checked";}?>>
									Composmentis</td>
									<td>4</td>
									<?php 
									if($tkulit5){
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit6' value='YA' <?php if ($tkulit6=="YA"){echo "checked";}?>>
									Apatis</td>
									<td>3</td>
									<?php 
									if($tkulit6){
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit7' value='YA' <?php if ($tkulit7=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit8' value='YA' <?php if ($tkulit8=="YA"){echo "checked";}?>>
									Koma/stupor</td>
									<td>1</td>
									<?php 
									if($tkulit8){
								...
								<tr>
									<td>3</td>
									<td>Rentang aktifitas</td>
									<td><input type='checkbox' name='tkulit9' value='YA' <?php if ($tkulit9=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit10' value='YA' <?php if ($tkulit10=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit11' value='YA' <?php if ($tkulit11=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit12' value='YA' <?php if ($tkulit12=="YA"){echo "checked";}?>>
									Pasien bedrest</td>
									<td>1</td>
									<?php 
									if($tkulit12){
								...
								<tr>
									<td>4</td>
									<td>Mobilitas</td>
									<td><input type='checkbox' name='tkulit13' value='YA' <?php if ($tkulit13=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit14' value='YA' <?php if ($tkulit14=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit15' value='YA' <?php if ($tkulit15=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit16' value='YA' <?php if ($tkulit16=="YA"){echo "checked";}?>>
								...
								<tr>
									<td>5</td>
									<td>Inkotinentia</td>
									<td><input type='checkbox' name='tkulit17' value='YA' <?php if ($tkulit17=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit18' value='YA' <?php if ($tkulit18=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit19' value='YA' <?php if ($tkulit19=="YA"){echo "checked";}?>>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type='checkbox' name='tkulit20' value='YA' <?php if ($tkulit20=="YA"){echo "checked";}?>>
							...
							<input type='checkbox' name='endokrin1' value='Tidak' <?php if ($endokrin1=="Tidak"){echo "checked";}?>> Tidak     
							<input type='checkbox' name='endokrin1' value='Ya' <?php if ($endokrin1=="Ya"){echo "checked";}?>> Ya<br>
							Pembesaran kel. Getah bening :     
							<input type='checkbox' name='endokrin2' value='Tidak' <?php if ($endokrin2=="Tidak"){echo "checked";}?>>Tidak      
							<input type='checkbox' name='endokrin2' value='Ya' <?php if ($endokrin2=="Ya"){echo "checked";}?>>Ya<br>
							Hiperglikemi   :  
							<input type='checkbox' name='endokrin3' value='Tidak' <?php if ($endokrin3=="Tidak"){echo "checked";}?>>Tidak      
							<input type='checkbox' name='endokrin3' value='Ya' <?php if ($endokrin3=="Ya"){echo "checked";}?>>Ya,
							sebutkan : <input type='text' name='endokrin4' value='<?php echo $endokrin4;?>'><br>
							<input type='submit' name='simpan' value='simpan'>&nbsp;
							<hr>
							J. REPRODUKSI<br>
							Wanita    : 
							<input type='checkbox' name='reproduksi1' value='Tidak ada kelainan' <?php if ($reproduksi1=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan
							<input type='checkbox' name='reproduksi1' value='Sedang Hamil' <?php if ($reproduksi1=="Sedang Hamil"){echo "checked";}?>>Sedang Hamil<br>
							Menstruasi pertama :   
							<input type='checkbox' name='reproduksi2' value='Teratur' <?php if ($reproduksi2=="Teratur"){echo "checked";}?>>Teratur  
							<input type='checkbox' name='reproduksi2' value='Tidak Teratur' <?php if ($reproduksi2=="Tidak Teratur"){echo "checked";}?>>Tidak Teratur<br>
							Laki – Laki : 
							<input type='checkbox' name='reproduksi3' value='Tidak ada kelainan' <?php if ($reproduksi3=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan   
							<input type='checkbox' name='reproduksi3' value='Ada kelainan' <?php if ($reproduksi3=="Ada kelainan"){echo "checked";}?>>Ada Kelainan<br>
							<input type='submit' name='simpan' value='simpan'>&nbsp;
						</td>
						<td>
							<input type='checkbox' name='maktifitas1' value='Intoleransi aktivitas' <?php if ($maktifitas1=="Intoleransi aktivitas"){echo "checked";}?>>Intoleransi aktivitas<br>
							<input type='checkbox' name='maktifitas2' value='Defisit perawatan diri' <?php if ($maktifitas2=="Defisit perawatan diri"){echo "checked";}?>>Defisit perawatan diri<br>
							<input type='checkbox' name='maktifitas3' value='Gangguan Mobilitas fisik' <?php if ($maktifitas3=="Gangguan Mobilitas fisik"){echo "checked";}?>>Gangguan Mobilitas fisik<br>
							<input type='checkbox' name='maktifitas4' value='Gangguan integritas kulit/jaringan' <?php if ($maktifitas4=="Gangguan integritas kulit/jaringan"){echo "checked";}?>>Gangguan integritas kulit/jaringan<br>
							<input type='checkbox' name='maktifitas5' value='Resiko infeksi' <?php if ($maktifitas5=="Resiko infeksi"){echo "checked";}?>>Resiko infeksi<br>
							<input type='checkbox' name='maktifitas6' value='Hiperglikemi' <?php if ($maktifitas6=="Hiperglikemi"){echo "checked";}?>>Hiperglikemi<br>
							<input type='checkbox' name='maktifitas7' value='Hipoglikemi' <?php if ($maktifitas7=="Hipoglikemi"){echo "checked";}?>>Hipoglikemi<br>
							Masalah Lain <input type='text' name='maktifitas8' value='<?php echo $maktifitas8;?>'><br>
							<input type='submit' name='simpan' value='simpan'>&nbsp;
						</td>
					</tr>	
					<tr>
						<td>
							...
							<table>
								...
								<tr>
									<td>Riwayat jatuh</td>
									<td><input type='checkbox' name='tjatuh1' value='YA' <?php if ($tjatuh1=="YA"){echo "checked";}?>>Ya</td>
									<td>25</td>
									<td>
										<?php 
										if($tjatuh1){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh2' value='YA' <?php if ($tjatuh2=="YA"){echo "checked";}?>>Tidak</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh2){
								...
								<tr>
									<td>Diagnosis skunder (≥diagnosis medis)</td>
									<td><input type='checkbox' name='tjatuh3' value='YA' <?php if ($tjatuh3=="YA"){echo "checked";}?>>Ya</td>
									<td>15</td>
									<td>
										<?php 
										if($tjatuh3){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh4' value='YA' <?php if ($tjatuh4=="YA"){echo "checked";}?>>Tidak</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh4){
								...
								<tr>
									<td>Alat bantu</td>
									<td><input type='checkbox' name='tjatuh5' value='YA' <?php if ($tjatuh5=="YA"){echo "checked";}?>>Berpegangan pada perabot, kursi roda</td>
									<td>30</td>
									<td>
										<?php 
										if($tjatuh5){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh6' value='YA' <?php if ($tjatuh6=="YA"){echo "checked";}?>>Tongkat/walker</td>
									<td>15</td>
									<td>
										<?php 
										if($tjatuh6){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh7' value='YA' <?php if ($tjatuh7=="YA"){echo "checked";}?>>Tidak ada/perawat/tirah baring</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh7){
								...
								<tr>
									<td>Terpasang infus/terapi intravena </td>
									<td><input type='checkbox' name='tjatuh8' value='YA' <?php if ($tjatuh8=="YA"){echo "checked";}?>>Ya</td>
									<td>20</td>
									<td>
										<?php 
										if($tjatuh8){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh9' value='YA' <?php if ($tjatuh9=="YA"){echo "checked";}?>>Tidak</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh9){
								...
								<tr>
									<td>Gaya berjalan</td>
									<td><input type='checkbox' name='tjatuh10' value='YA' <?php if ($tjatuh10=="YA"){echo "checked";}?>>Kerusakan</td>
									<td>20</td>
									<td>
										<?php 
										if($tjatuh10){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh11' value='YA' <?php if ($tjatuh11=="YA"){echo "checked";}?>>Kelemahan</td>
									<td>10</td>
									<td>
										<?php 
										if($tjatuh11){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh12' value='YA' <?php if ($tjatuh12=="YA"){echo "checked";}?>>Normal /tirah baring/imobilisasi</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh12){
								...
								<tr>
									<td>Status mental</td>
									<td><input type='checkbox' name='tjatuh13' value='YA' <?php if ($tjatuh13=="YA"){echo "checked";}?>>Tidak konsisten dengan perintah</td>
									<td>15</td>
									<td>
										<?php 
										if($tjatuh13){
								...
								<tr>
									<td></td>
									<td><input type='checkbox' name='tjatuh14' value='YA' <?php if ($tjatuh14=="YA"){echo "checked";}?>>Sadar akan kemampuan diri sendiri</td>
									<td>0</td>
									<td>
										<?php 
										if($tjatuh14){
							...
							<input type='checkbox' name='asdewasa1' value='Tidak' <?php if ($asdewasa1=="Tidak"){echo "checked";}?>>Tidak    
							<input type='checkbox' name='asdewasa1' value='Ya' <?php if ($asdewasa1=="Ya"){echo "checked";}?>>Ya<br>
							Kondisi Pasien  :   
							...
							pasien kooperatif :   
							<input type='checkbox' name='asdewasa3' value='Ya' <?php if ($asdewasa3=="Ya"){echo "checked";}?>>Ya       
							<input type='checkbox' name='asdewasa3' value='Tidak' <?php if ($asdewasa3=="Tidak"){echo "checked";}?>>Tidak<br>
							Kondisi saat ini berisiko :   
							<input type='checkbox' name='asdewasa4' value='Tidak' <?php if ($asdewasa4=="Tidak"){echo "checked";}?>>Tidak     
							<input type='checkbox' name='asdewasa4' value='Ya' <?php if ($asdewasa4=="Ya"){echo "checked";}?>>Ya, lanjutan dengan pengkajian restrain.<br>
							<input type='submit' name='simpan' value='simpan'>
							<hr>
							L. ISTIRAHAT DAN TIDUR<br>
							Lama tidur          :    
							<input type='checkbox' name='asdewasa5' value='Tidak ada kelainan' <?php if ($asdewasa5=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan     
							<input type='checkbox' name='asdewasa5' value='Ada kelainan' <?php if ($asdewasa5=="Ada kelainan"){echo "checked";}?>>Ada kelainan :<br>
							Gangguan istirahat    :    
							<input type='checkbox' name='asdewasa6' value='Tidak ada kelainan' <?php if ($asdewasa6=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan     
							<input type='checkbox' name='asdewasa6' value='Ada kelainan' <?php if ($asdewasa6=="Ada kelainan"){echo "checked";}?>>Ada kelainan :<br>
							Penggunaan obat tidur  :    
							<input type='checkbox' name='asdewasa7' value='Tidak ada kelainan' <?php if ($asdewasa7=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada kelainan    
							<input type='checkbox' name='asdewasa7' value='Ada kelainan' <?php if ($asdewasa7=="Ada kelainan"){echo "checked";}?>>Ada kelainan :<br>
							<input type='submit' name='simpan' value='simpan'>
							<hr>
							M. KEBUTUHAN KOMUNIKASI, KOGNISI DAN EDUKASI<br>
							Bicara :   
							<input type='checkbox' name='asdewasa8' value='Normal' <?php if ($asdewasa8=="Normal"){echo "checked";}?>>Normal      
							<input type='checkbox' name='asdewasa8' value='Gangguan Bicara' <?php if ($asdewasa8=="Gangguan Bicara"){echo "checked";}?>>Gangguan Bicara :<br>
							Mulai kapan : <input type='text' name='asdewasa9' value='<?php echo $asdewasa9;?>'><br>
							Memerlukan Bahasa Isyarat :    
							<input type='checkbox' name='asdewasa10' value='Tidak' <?php if ($asdewasa10=="Tidak"){echo "checked";}?>>Tidak     
							<input type='checkbox' name='asdewasa10' value='Ya' <?php if ($asdewasa10=="Ya"){echo "checked";}?>>Ya<br>
							Hambatan Belajar : 
							...
							Keadaan Psikologis   :    
							<input type='checkbox' name='asdewasa12' value='Kooperatif' <?php if ($asdewasa12=="Kooperatif"){echo "checked";}?>>Kooperatif      
							<input type='checkbox' name='asdewasa12' value='Sedih' <?php if ($asdewasa12=="Sedih"){echo "checked";}?>>Sedih   
							<input type='checkbox' name='asdewasa12' value='Marah' <?php if ($asdewasa12=="Marah"){echo "checked";}?>>Marah
							<input type='checkbox' name='asdewasa12' value='Agitasi' <?php if ($asdewasa12=="Agitasi"){echo "checked";}?>>Agitasi        
							<input type='checkbox' name='asdewasa12' value='Cemas' <?php if ($asdewasa12=="Cemas"){echo "checked";}?>>Cemas   
							<input type='checkbox' name='asdewasa12' value='Gelisah' <?php if ($asdewasa12=="Gelisah"){echo "checked";}?>>Gelisah
							<input type='checkbox' name='asdewasa12' value='Disorientasi' <?php if ($asdewasa12=="Disorientasi"){echo "checked";}?>>Disorientasi:    
							<input type='checkbox' name='asdewasa12' value='Orang' <?php if ($asdewasa12=="Orang"){echo "checked";}?>>Orang   
							<input type='checkbox' name='asdewasa12' value='Tempat' <?php if ($asdewasa12=="Tempat"){echo "checked";}?>>Tempat   
							<input type='checkbox' name='asdewasa12' value='Waktu' <?php if ($asdewasa12=="Waktu"){echo "checked";}?>>Waktu<br>
							Tingkat Pendidikan :    
							<input type='checkbox' name='asdewasa13' value='Belum Sekolah' <?php if ($asdewasa13=="Belum Sekolah"){echo "checked";}?>>Belum Sekolah   
							<input type='checkbox' name='asdewasa13' value='SD' <?php if ($asdewasa13=="SD"){echo "checked";}?>>SD     
							<input type='checkbox' name='asdewasa13' value='SMP' <?php if ($asdewasa13=="SMP"){echo "checked";}?>>SMP
							<input type='checkbox' name='asdewasa13' value='SMA' <?php if ($asdewasa13=="SMA"){echo "checked";}?>>SMA           
							<input type='checkbox' name='asdewasa13' value='Diploma' <?php if ($asdewasa13=="Diploma"){echo "checked";}?>>Diploma  
							<input type='checkbox' name='asdewasa13' value='Sarjana' <?php if ($asdewasa13=="Sarjana"){echo "checked";}?>>Sarjana<br>
							Pekerjaan         :    
							<input type='checkbox' name='asdewasa14' value='Wiraswasta' <?php if ($asdewasa14=="Wiraswasta"){echo "checked";}?>>Wiraswasta      
							<input type='checkbox' name='asdewasa14' value='Swasta' <?php if ($asdewasa14=="Swasta"){echo "checked";}?>>Swasta   
							<input type='checkbox' name='asdewasa14' value='Peg.Negeri' <?php if ($asdewasa14=="Peg.Negeri"){echo "checked";}?>>Peg.Negeri<br>
							Tinggal Bersama   :    
							<input type='checkbox' name='asdewasa15' value='Suami/istri ' <?php if ($asdewasa15=="Suami/istri "){echo "checked";}?>>Suami/istri      
							<input type='checkbox' name='asdewasa15' value='Anak' <?php if ($asdewasa15=="Anak"){echo "checked";}?>>Anak   
							<input type='checkbox' name='asdewasa15' value='Teman' <?php if ($asdewasa15=="Teman"){echo "checked";}?>>Teman
							<input type='checkbox' name='asdewasa15' value='Orang Tua ' <?php if ($asdewasa15=="Orang Tua "){echo "checked";}?>>Orang Tua       
							<input type='checkbox' name='asdewasa15' value='Sendiri' <?php if ($asdewasa15=="Sendiri"){echo "checked";}?>>Sendiri  
							<input type='checkbox' name='asdewasa15' value='Caregiver' <?php if ($asdewasa15=="Caregiver"){echo "checked";}?>>Caregiver<br>
							Status Ekonomi    :    
							<input type='checkbox' name='asdewasa16' value='Pembayaran Pribadi/Perorangan' <?php if ($asdewasa16=="Pembayaran Pribadi/Perorangan"){echo "checked";}?>>Pembayaran Pribadi/Perorangan
							<input type='checkbox' name='asdewasa16' value='Jaminan kesehatan/Asuransi' <?php if ($asdewasa16=="Jaminan kesehatan/Asuransi"){echo "checked";}?>>Jaminan kesehatan/Asuransi<br>
							Spiritual<br>
							Menjalankan ibadah    :   
							<input type='checkbox' name='asdewasa17' value='Ada Hambatan' <?php if ($asdewasa17=="Ada Hambatan"){echo "checked";}?>>Ada Hambatan    :   
							<input type='checkbox' name='asdewasa17' value='Tidak ada hambatan' <?php if ($asdewasa17=="Tidak ada hambatan"){echo "checked";}?>>Tidak ada hambatan<br>
							Persepsi terhadap Sakit :   
							<input type='checkbox' name='asdewasa18' value='Tidak Ada Keluhan' <?php if ($asdewasa18=="Tidak Ada Keluhan"){echo "checked";}?>>Tidak Ada Keluhan     
							<input type='checkbox' name='asdewasa18' value='Rasa Bersalah' <?php if ($asdewasa18=="Rasa Bersalah"){echo "checked";}?>>Rasa Bersalah<br>
							Meminta Pelayanan Spiritual :    
							<input type='checkbox' name='asdewasa19' value='Tidak Ada Keluhan' <?php if ($asdewasa19=="Tidak Ada Keluhan"){echo "checked";}?>>Tidak Ada Keluhan      
							<input type='checkbox' name='asdewasa19' value='Ya' <?php if ($asdewasa19=="Ya"){echo "checked";}?>>Ya, (lakukan kolaborasi dengan bagian kerohanian)<br>
							<input type='submit' name='simpan' value='simpan'>
							<hr>
							...
							<table>
								...
								<tr>
									<td>1</td>
									<td>Usia ≥60 tahun</td>
									<td><input type='checkbox' name='asdewasa20' value='Ya' <?php if ($asdewasa20=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa20' value='Tidak' <?php if ($asdewasa20=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>2</td>
									<td>Tinggal sendirian tanpa dukungan sosial secara langsung</td>
									<td><input type='checkbox' name='asdewasa21' value='Ya' <?php if ($asdewasa21=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa21' value='Tidak' <?php if ($asdewasa21=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>3</td>
									<td>Stroke, serangan Jantung, PPOK, gagal jantung kongestif, empisema demensia, TB, alzeimer, AIDS, atau penyakit dengan potensi mengancam nyawa lainnya</td>
									<td><input type='checkbox' name='asdewasa22' value='Ya' <?php if ($asdewasa22=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa22' value='Tidak' <?php if ($asdewasa22=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>4</td>
									<td>Korban dari kasus criminal</td>
									<td><input type='checkbox' name='asdewasa23' value='Ya' <?php if ($asdewasa23=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa23' value='Tidak' <?php if ($asdewasa23=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>5</td>
									<td>Trauma Multiple</td>
									<td><input type='checkbox' name='asdewasa24' value='Ya' <?php if ($asdewasa24=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa24' value='Tidak' <?php if ($asdewasa24=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>6</td>
									<td>Memerlukan Perawatan atau pengobatan berkelanjutan</td>
									<td><input type='checkbox' name='asdewasa25' value='Ya' <?php if ($asdewasa25=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa25' value='Tidak' <?php if ($asdewasa25=="Tidak"){echo "checked";}?>></td>
								</tr>
								<tr>
									<td>7</td>
									<td>Pasien lansia yang ada dilantai atas (saat dirumah)</td>
									<td><input type='checkbox' name='asdewasa26' value='Ya' <?php if ($asdewasa26=="Ya"){echo "checked";}?>></td>
									<td><input type='checkbox' name='asdewasa26' value='Tidak' <?php if ($asdewasa26=="Tidak"){echo "checked";}?>></td>
								</tr>


								<tr>
									<td colspan="4">Bila salah satu jawaban adalah ya, dilanjutkan pengisian rm 18a.10 discharge planning terintegrasi</td>
								</tr>
						...
						<td>
							<input type='checkbox' name='asdewasa27' value='Resiko jatuh' <?php if ($asdewasa27=="Resiko jatuh"){echo "checked";}?>>Resiko jatuh<br>
							<input type='checkbox' name='asdewasa28' value='Gangguan pola tidur' <?php if ($asdewasa28=="Gangguan pola tidur"){echo "checked";}?>>Gangguan pola tidur<br>
							<input type='checkbox' name='asdewasa29' value='Gangguan komunikasi verbal' <?php if ($asdewasa29=="Gangguan komunikasi verbal"){echo "checked";}?>>Gangguan komunikasi verbal<br>
							<input type='checkbox' name='asdewasa30' value='Ansietas' <?php if ($asdewasa30=="Ansietas"){echo "checked";}?>>Ansietas<br>
							<input type='checkbox' name='asdewasa31' value='Berduka' <?php if ($asdewasa31=="Berduka"){echo "checked";}?>>Berduka<br>
							<input type='checkbox' name='asdewasa32' value='Gangguan rasa nyaman' <?php if ($asdewasa32=="Gangguan rasa nyaman"){echo "checked";}?>>Gangguan rasa nyaman<br>
							Lainnya : <input type='text' name='asdewasa33' value='<?php echo $asdewasa33;?>'> <br>
							<input type='submit' name='simpan' value='simpan'>
						</td>
					</tr>	
				</table>	
