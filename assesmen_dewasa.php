							...
							<td colspan='2'>
								<table border="0">
									...
									<tr>
										...
										<td>: <input type='text' name='riwayat_penyakit_sekarang' value='<?php echo $riwayat_penyakit_sekarang;?>'></td>
									</tr>
									<tr>
										<td>Riwayat penyakit dahulu</td>
										<td>: <input type='text' name='riwayat_penyakit_dahulu' value='<?php echo $riwayat_penyakit_dahulu;?>'></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>: <input type='checkbox' name='riwayat_alergi' value='Tidak' <?php if ($riwayat_alergi=="Tidak"){echo "checked";}?>>Tidak
							...
							<td>
								...
								<table border="0">
									...
									<tr>
										...
										<td coslpan='2'> 
											...
											M : <input type='text' name='ku_gcs_m' value='<?php echo $ku_gcs_m;?>'>
										</td>
									</tr>
									<tr><td>Suhu</td>
										<td colspan='2'>
											<input type='text' name='ku_suhu' value='<?php echo $ku_suhu;?>' size='5'>
											Tekanan Darah : <input type='text' name='ku_tensi' value='<?php echo $ku_tensi;?>'> /mmHg
											...
											<input type='checkbox' name='ku_nadi_ket' value='Tidak Teratur' <?php if ($ku_kesadaran=="Tidak Teratur"){echo "checked";}?>>Tidak Teratur
										</td>
									</tr>
									<tr>
										<td>Nafas</td>
								...
								<table border="0">
									...
									<tr>
										<td>Suara Jantung</td>
										<td coslpan='2'>:
											<input type='checkbox' name='ku_suara_jantung' value='Tidak ada kelainan' <?php if ($ku_suara_jantung=="Tidak ada kelainan"){echo "checked";}?>>Tidak ada <input type='checkbox' name='ku_suara_jantung' value='kelainan' <?php if ($ku_suara_jantung=="kelainan"){echo "checked";}?>>kelainan
										</td>
									</tr>
									<tr>
										<td>Akral</td>
