		...
		<body onload="document.myForm.pasien_mcu.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					&nbsp;&nbsp;
					<a href='r_soap.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-info btn-sm'><i class="bi bi-file-earmark-text"></i>
					</a>
					&nbsp;&nbsp;
					<a href='soap.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success btn-sm'><i class="bi bi-plus-circle"></i></a>
					&nbsp;&nbsp;
					...
					<table class="table table-bordered">
						...
						<td><font color='white'>TULBAKON</td>
						<td><font color='white'>Oper Shift</td>
							...
							//oper shift
								...
								if($antropometri){
									...
									if($jam < 24){
										...
										<td align='center'><a href='tulbakon.php?id=$id|$user|$dl[id]'><font size='5'><i class='bi bi-clipboard-check'></i></font></a></td>					
										<td align='center'><a href='opershift.php?id=$id|$user|$dl[id]'><font size='5'><i class='bi bi-toggle-on'></i></font></a> 
										$status_oper </td>
										<td align='center'>
										$keterangan
										<a href='edit_soap.php?id=$id|$user|$dl[id]'><font size='5'><i class='bi bi-file-earmark-text'></i></font></a>
								...
								if(substr($dl[noreg], 0,1)=="R"){ //jika rawat inap
									...
									if($jam < 24){
										...
										<font size='5'><i class='bi bi-clipboard-check'></i></font>
										</a>
										</td>					
										<td align='center'>
										<a href='opershift.php?id=$id|$user|$dl[id]' onclick=\"return confirm('Pindah shift operasi untuk data ini?')\">
										<font size='5'><i class='bi bi-toggle-on'></i></font>
										</a> 
										$status_oper 
										</td>
										<td align='center'>
										$keterangan
										<a href='edit_soap.php?id=$id|$user|$dl[id]' onclick=\"return confirm('Apakah Anda yakin ingin mengedit data ini?')\">
										<font size='5'><i class='bi bi-file-earmark-text'></i></font>
										</a>
										<a href='del_cppt.php?id=$id|$user|$dl[id]' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">
										<font size='5'><i class='bi bi-trash'></i></font>
										</a>
										</td>					
										</tr>";
									}else{
