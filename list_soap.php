			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<table border="1" cellpadding="5px">
					...
					while   ($dl = sqlsrv_fetch_array($hl, SQLSRV_FETCH_ASSOC)){   
						...
						<td>$keterangan</td>
						<td><a href='edit_soap.php?id=$id|$user|$dl[id]'>Edit SOAP</td>						
						<td><a href='tulbakon.php?id=$id|$user|$dl[id]'>Tulbakon/Sbar</td>					
						<td><a href='opershift.php?id=$id|$user|$dl[id]'>Oper Shift</td>											
						</tr>
						";
						$no += 1;
					}
