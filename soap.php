			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<label for="" class="col-12">Status Lokalis : </label>
								<input class="form-control" name="status_lokalis" value="<?php echo $status_lokalis;?>" id="" type="text" size='' onfocus="nextfield ='pemeriksaan_penunjang';" placeholder=""><br>															
								<label for="" class="col-12">Pemeriksaan Penunjang : </label>
								<input class="form-control" name="pemeriksaan_penunjang" value="<?php echo $pemeriksaan_penunjang;?>" id="" type="text" size='' onfocus="nextfield ='simpan';" placeholder=""><br>											
							</div>
						</div>
					</div>
...
if (isset($_POST["simpan"])) {
	...
	$total_gcs = intval($eye)+intval($verbal)+intval($movement);
