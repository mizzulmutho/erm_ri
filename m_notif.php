		...
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-8">
						<input class="" name="notif" value="TERDAPAT PASIEN DENGAN NAMA SAMA" id="" type="radio">TERDAPAT PASIEN DENGAN NAMA SAMA
					</div>										
				</div>
				<br><br>
				<div class="row">
					...
					<div class="col-6 align-self-center">
						...
						<button type="submit" name="hapus" class="btn btn-warning btn-sm" onfocus="nextfield ='done';">hapus</button> 
...
if (isset($_POST["hapus"])) {
	$q  = "delete from ERM_NOTIF where noreg='$noreg'";
