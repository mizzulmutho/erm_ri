		...
		<body onload="document.myForm.nama_obat.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					<br>
					<a href='lab_list_dokter.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-warning'><i class="bi bi-x-circle"></i> Close</a>
					&nbsp;&nbsp;
					<a href='' class='btn btn-success'><i class="bi bi-arrow-clockwise"></i></a>
					&nbsp;&nbsp;
					<!-- <a href='#' class='btn btn-info' target='_blank'><i class="bi bi-printer-fill"></i></a> -->
					<a href='del_list_lab.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-danger'><i class="bi bi-x-circle"></i> Hapus Pilihan</a>
					&nbsp;&nbsp;
					<br>
					<br>
<!-- 				<div class="row">
			...
			<table class='table'>
				<tr>
					...
					<td style="border: 1px solid;" bgcolor='#708090' align="center"><font color='white'>nilai normal</font></td>
					<td style="border: 1px solid;" bgcolor='#708090' align="center"><font color='white'>flag</font></td>
				...
				while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
					...
					<td bgcolor='$color'>$data[NILAI_RUJUKAN]</td>
					<td bgcolor='$color'>$data[FLAG]</td>
					<td bgcolor='$color' align='center'>
					<a href='i_lab.php?id=$id|$user|$data[ID_HASIL]|$data[TGLLAB]'>
					<font color='gren'><i class='bi bi-check-all'></i></font>
					</a>
					</td>
					<td bgcolor='$color' align='center'>
					<a href='i_lab_batal.php?id=$id|$user|$data[ID_HASIL]|$data[TGLLAB]'>
