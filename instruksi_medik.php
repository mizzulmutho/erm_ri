...
$qi="SELECT noreg FROM ERM_RI_INSTRUKSI_MEDIK where noreg='$noreg'";
$hi  = sqlsrv_query($conn, $qi);        
$di  = sqlsrv_fetch_array($hi, SQLSRV_FETCH_ASSOC); 
$regcek = $di['noreg'];

if(empty($regcek)){
    $q  = "insert into ERM_RI_INSTRUKSI_MEDIK(noreg,userid,tglentry,tgl) values ('$noreg','$user','$tgl','$tgl')";
    $hs = sqlsrv_query($conn,$q);
}else{

    $qe="
    SELECT *,CONVERT(VARCHAR, tgl, 23) as tgl
    FROM ERM_RI_INSTRUKSI_MEDIK
    where noreg='$noreg'";
...
<!--                <div class="row">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <b>Instruksi Medik dan Keperawatan </b><br>
                </div>
            </div>
                    ...
                    <td>
                        <div class="row">
                            ...
                            <div class="col-8">
                             ...
                             ?> 
                             <textarea name= "rencana" id="" style="min-width:650px; min-height:250px;"><?php echo $rencana;?></textarea>
                             <br><br><br><br><br><br>
                         </div>
                     </div>
                 </td>
...
if (isset($_POST["simpan"])) {
    ...
    $q  = "update ERM_RI_INSTRUKSI_MEDIK set
    rencana ='$rencana'
    where noreg='$noreg'
    ";
