	...
	<body onload="document.myForm.td_sistolik.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				<br>
				<a href='observasi.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-warning btn-sm'><i class="bi bi-x-circle"></i> Close</a>
				&nbsp;&nbsp;
				...
				<div class="row">
					<div class="col-12">
						...
						<tr><td>Skor EWS </td><td>: &nbsp;&nbsp; <input class="" name="total_ews" value="<?php echo $total_ews;?>" id="" type="text" size='20' placeholder="">&nbsp;>muncul otomatis sesuai skor&nbsp;</td></tr>
