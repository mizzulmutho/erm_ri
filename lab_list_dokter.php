		...
		<body onload="document.myForm.nama_obat.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					<br>
					<a href='soap_dokter.php?id=<?php echo $id.'|'.$user.'|i_lab';?>' class='btn btn-warning'><i class="bi bi-x-circle"></i> Close</a>
					&nbsp;&nbsp;
...
<!-- 				<div class="row">
			...
			<div class="row">
				<div class="col-12 text-center">
					<b>LIST HASIL LABORAT PER TANGGAL</b><br>
				</div>
			</div>
			...
			<table class='table'>
				<tr>
					...
					<td style="border: 1px solid;" bgcolor='#708090' align="center"><font color='white'>Click untuk menampilkan detail item</font></td>
				</tr>
				<?php 
				$q="
				SELECT DISTINCT
				...
				while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
					...
					<a href='lab_list_dokter_detail.php?id=$id|$user|$data[TGLLAB]'>
					<font color='gren'><i class='bi bi-check-all'></i> Tampilkan Detail </font>
					</a>
					</td>
					</tr>
					";
