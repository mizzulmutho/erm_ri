...
if(empty($regcek)){
	$q  = "insert into ERM_RI_RENCANA_PULANG(noreg,userid,tglentry,tgl) values ('$noreg','$user','$tgl','$tgl')";
	$hs = sqlsrv_query($conn,$q);
}else{

	$qe="
	SELECT *,CONVERT(VARCHAR, tgl, 23) as tgl
	FROM ERM_RI_RENCANA_PULANG
	where noreg='$noreg'";
...
<!-- 				<div class="row">
			...
			<div class="row">
				<div class="col-12 text-center">
					<b>Perencanaan Pemulangan Pasien </b><br>
				</div>
			</div>
			...
			<table width='100%' border='1'>
				...
				<tr>
					<td>
						<div class="row">
							<div class="col-4">
								Perencanaan Pemulangan Pasien<br>
...
if (isset($_POST["simpan"])) {
	...
	$q  = "update ERM_RI_RENCANA_PULANG set
	rencana	='$rencana'
	where noreg='$noreg'
	";
