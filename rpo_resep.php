		...
		<font size='2px'>
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-6">
						<div class="row">
							<div class="col-12 text-center">
								<b>REKAM PEMBERIAN OBAT</b><br><br>
							</div>
						</div>
								...
								while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
									...
									<tr>
										...
										<td>									
											<?php 
											$q2="
											select TOP(100) userid,nama_obat,jumlah,dosis,waktu_penggunaan,
											...
											<td width='10%'>apoteker</td>
											<td width='10%'>periksa</td>
											<td width='10%'>pemberi</td>
											<td width='10%'>keluarga</td>
											</tr>";
											...
											while   ($data2 = sqlsrv_fetch_array($hasil2,SQLSRV_FETCH_ASSOC)){ 
												...
												<td>$data2[tgl]</td>
												<td>$data2[dokter]</td>
												<td>$data2[apoteker]</td>
												<td>$data2[periksa]</td>
												<td>$data2[pemberi]</td>
												<td>$data2[keluarga]</td>
												</tr>
												";
												$no2 += 1;
											}
					...
					<div class="col-6">
						<iframe src="http://192.168.10.4:1234/rekam_medik/entry_tindakan/rawat_inap/<?php echo $KODEUNIT;?>/<?php echo $noreg; ?>/<?php echo $norm; ?>/resep/" width="100%" height="800" scrolling="no" style="overflow:hidden; margin-top:-4px; margin-left:-4px; border:none;"></iframe>
					</div>
				</div>
