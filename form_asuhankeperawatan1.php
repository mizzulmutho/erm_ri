	...
	<body onload="document.myForm.pasien_mcu.focus();">
		<font size='2px'>	
			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				&nbsp;&nbsp;
				<a href='form_asuhankeperawatan_baru.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success'><i class="bi bi-file-earmark-plus"></i></a>
				&nbsp;&nbsp;
				...
				<table class="table" border="1">
					<?php
					$ql="
					SELECT        ERM_ASUHAN_KEPERAWATAN.id,ERM_ASUHAN_KEPERAWATAN.diagnosa_keperawatan, ERM_MASTER_ASUHANKEPERAWATAN.diagnosa_nama
					...
					echo 
					"<tr bgcolor='#969392'>
					<td>no</td><td>diagnosa_keperawatan</td><td>diagnosa_nama</td><td>action</td>
					</tr>";
					while   ($dl = sqlsrv_fetch_array($hl, SQLSRV_FETCH_ASSOC)){         
						...
						<td><a href='form_asuhankeperawatan2.php?id=$id|$user|$dl[id]'>edit</a></td>
						</tr>
						";
						$no += 1;
					}
