				...
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-12 text-center">
							...
							INPATIENT DISCHARGE SUMMARY (MEDICAL RESUME)<br>
							<b><font color='red'>BELUM TERVERIFIKASI (Lakukan Verifikasi Data Resume Medis)</font></b>
						</div>
					</div>
					<hr> 
					<div class="row">
...
<!-- 				<select id="resume21" name="resume21">
			...
			if(preg_match("/NON/i", $resume21) or preg_match("/END/i", $resume21)) {
				$resume20 = trim(substr($resume21,7,500));
			}else{
...
<!-- 			<select id="resume22" name="resume22">
			...
			<?php 
			$row = explode('-',$resume22);$resume22  = $row[1];if(empty($resume22)){$resume22  = $row[0];}
			echo $resume22; 
			?>
			<br>
			<?php
