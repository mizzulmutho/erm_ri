		...
		<body onload="document.myForm.nama_obat.focus();">
			<font size='2px'>
				<form method="POST" name='myForm' action="" enctype="multipart/form-data">
					<br>
					<a href='eresep_list_discharge.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-warning'><i class="bi bi-x-circle"></i> Close</a>
					&nbsp;&nbsp;
...
<!-- 				<div class="row">
			...
			<table class='table'>
				...
				W_EResep_R.WaktuPakai, W_EResep_R.Keterangan, W_EResep_R.Satuan, Afarm_MstSatuan.NAMASATUAN, W_EResep_Racikan.Nama
				...
				while   ($data = sqlsrv_fetch_array($hasil,SQLSRV_FETCH_ASSOC)){ 
					...
					$qur="SELECT noreg FROM ERM_RI_DISCHARGE where noreg='$noreg' and id_eresep_detail=$data[Id]";
					...
					<td>$data[Jumlah]</td>
					<td align='center'>
					<a href='i_discharge_resep.php?id=$id|$user|$idresep|$data[Id]'>
