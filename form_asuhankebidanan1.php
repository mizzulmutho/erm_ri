	...
	<body onload="document.myForm.pasien_mcu.focus();">
		<font size='2px'>	
			...
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				<br>
				<a href='r_asuhankebidanan.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-warning'>Close</a>
				&nbsp;&nbsp;
				<a href='' class='btn btn-success'><i class="bi bi-arrow-clockwise"></i></a>
				&nbsp;&nbsp;
				<a href='form_asuhankebidanan_baru.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-success'><i class="bi bi-file-earmark-plus"></i></a>
				&nbsp;&nbsp;
				...
				<table class="table" border="1">
					<?php
					$ql="
					SELECT        ERM_ASUHAN_KEPERAWATAN.id,ERM_ASUHAN_KEPERAWATAN.diagnosa_keperawatan, ERM_ASUHAN_KEPERAWATAN.diagnosa_nama
					...
					echo 
					"<tr bgcolor='#969392'>
					<td>no</td><td>diagnosa_kebidanan</td><td>diagnosa_nama</td><td>edit</td><td>implementasi</td>
					</tr>";
					while   ($dl = sqlsrv_fetch_array($hl, SQLSRV_FETCH_ASSOC)){         
						...
						<td><a href='form_asuhankebidanan2.php?id=$id|$user|$dl[id]'>edit</a></td>
						<td><a href='implementasi_bidan.php?id=$id|$user|$noreg|$dl[diagnosa_keperawatan]'>IMPLEMENTASI</a></td>
						</tr>
						";
						$no += 1;
					}
...
if (isset($_POST["simpan_rencana"])) {
	...
	// </script>
	// ";
	header('Location: i_asuhankebidanan1.php?id=$id|$user|$idrasuhan');
