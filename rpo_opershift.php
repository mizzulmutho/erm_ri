	...
	<body onload="document.myForm.kodedokter.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						<i class="bi bi-window-plus"> &nbsp; <b>INPUT OPER SHIFT DI RPO</b></i>
					</div>
				</div>
				<hr>
<!-- 				<div class="row">
...
<!-- 				<hr>
			...
			<div class="row">
				...
				<div class="col-6 align-self-center">
					<a href='rpo2.php?id=<?php echo $id.'|'.$user;?>' class='btn btn-warning btn-sm'>Close</a>
					&nbsp;&nbsp;&nbsp;
...
if (isset($_POST["simpan"])) {
	...
	if($lanjut == 'Y'){
		...
		$q  = "insert into ERM_OPERSHIFT_RPO
		(noreg, petugas, tglentry, userid, namapetugas) 
		values 
		('$noreg','$kodedokter','$tglinput','$user','$namadokter')";
		...
		echo "
		<script>
		top.location='rpo2.php?id='$id|$user';
		</script>
		"; 
