	...
	<body onload="document.myForm.pasien_mcu.focus();">
		<font size='2px'>	
			<form method="POST" name='myForm' action="" enctype="multipart/form-data">
				...
				<div class="row">
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="submit" name="edit_rencana" class="btn btn-warning btn-smal" onfocus="nextfield ='done';">edit deskripsi</button> 
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="submit" name="implementasi_rencana" class="btn btn-success btn-smal" onfocus="nextfield ='done';">Input Implementasi Asuhan</button> 
				</div>
				<br><br><br>
			</form>
		</font>
