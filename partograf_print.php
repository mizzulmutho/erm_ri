...
<!-- 				<div class="row">
			...
			<table width='80%' border='1'>
				<tr>
					<td>
						<div class="col-12">
							<?php 
                           $q       = "select par3,par4,par5 from ERM_RI_PARTOGRAF where noreg = '$noreg'";
                           $h  = sqlsrv_query($conn, $q);             
                           $d  = sqlsrv_fetch_array($h, SQLSRV_FETCH_ASSOC); 

                           if($par3){ $par3 = trim($d['par3']); echo "Gambar terupload : <img src='$par3' width='80%'>"; echo "<br>"; }
                           if($par4){ $par4 = trim($d['par4']); echo "Gambar terupload : <img src='$par4' width='80%'>";echo "<br>"; }
                           if($par5){ $par5 = trim($d['par5']); echo "Gambar terupload : <img src='$par5' width='80%'>";echo "<br>"; }
                           ?>
                       </div>
                   </td>
               </tr>
           ...
           <table width='80%' border='1'>
               <tr>
                   <td>
                     <iframe src="catatan_persalinan.php" width="100%" height="1900" style="border:1px solid black;">
                     </iframe>
                 </td>
             </tr>
         </table>
         ...
         <table width='80%' border='1'>
           <tr>
               <td>
                 <iframe src="observasi_persalinan.php" width="100%" height="900" style="border:1px solid black;">
                 </iframe>
             </td>
         </tr>
     </table>
